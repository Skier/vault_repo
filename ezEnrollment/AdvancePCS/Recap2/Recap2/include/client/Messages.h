...
// Main
#define FRAME_TITLE     "AdvancePCS Client"
#define FRAME_LOG_TITLE "AdvancePCS Messenger"

#define CONFIGURATION   "config.xml"
#define HEADER_SUB_CONF "header"
#define DETAIL_SUB_CONF "grid"
#define MAIL_SUB_CONF   "http-agent"
#define COMPOSER_CONF   "composer"
#define PRESENTATION_CONF "presentation"
...
#define USAGE "usage: AdvClient.exe [-cfg=cfgfilename] [-verify] " \
...
#define LOAD_XML_PRESENTATION_NOT_FOUND "Presentation configuration not found"
...
#define LOAD_XML_COMPOSER_NOT_FOUND "Composer configuration not found"
...
#define DESCRIPTOR_WRONG_ALIGNMENT "Wrong alignment must be L or R"
