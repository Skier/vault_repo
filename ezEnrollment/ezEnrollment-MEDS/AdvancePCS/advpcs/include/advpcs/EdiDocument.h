...
public:
    EdiDocument(const Descriptor& headerDesc, const Descriptor& detailDesc, const Descriptor& trailerDesc);
    ...
    bool IsFieldRequired(size_t index) const;
    ...
    void Clear();
		...
		//trailer place
	const Descriptor& GetTrailerDescriptor() const;
	const FieldDescriptor& GetTrailerFieldDescriptor(size_t index) const;
	wxString GetTrailerValue(size_t index) const;
...
//	void QuickSort(size_t from, size_t to, size_t column, bool ascend = true);
    ...
    wxString GetColHint(size_t row, size_t col) const;

    bool IsChanged() const { return m_changed; };

    bool IsColRequired(size_t row, size_t col) const;
...
private:
    ...
    const Descriptor& m_trailerDesc;
