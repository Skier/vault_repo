...
public:
    ...
    //trailer place
	virtual const Descriptor& GetTrailerDescriptor() const = 0;
	virtual const FieldDescriptor& GetTrailerFieldDescriptor(size_t index) const = 0;
	virtual wxString GetTrailerValue(size_t index) const = 0;
    ...
    virtual wxString GetColHint(size_t row, size_t col) const = 0;
...
//	virtual void QuickSort(size_t from, size_t to, size_t column, bool ascend = true) = 0;
    ...
    virtual bool IsColRequired(size_t row, size_t col) const = 0;
