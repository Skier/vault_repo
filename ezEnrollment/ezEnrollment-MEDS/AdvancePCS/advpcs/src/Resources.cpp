...
const wxString ADVPCS_TRAILER_CFG(wxT("trailer"));
const wxString ADVPCS_COUNTER_FILE_NAME(wxT("counter.ini"));
const wxString ADVPCS_AGENT_CFG(wxT("sftp-agent"));
...
const wxString ADVPCS_CFG_TRAILER_NOT_FOUND(_("Trailer configuration not found"));
