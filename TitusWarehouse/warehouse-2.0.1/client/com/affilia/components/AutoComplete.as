...
//	    setStyle("arrowButtonWidth",0);
 	...
 	override public function set dataProvider(value:Object):void
	{
        ...
        {
            super.dataProvider = new ArrayCollection(value.source);
        } else 
        {
	...
	{
		var textBefore:String = textInput.text;
		
	    super.updateDisplayList(unscaledWidth, unscaledHeight);
	    
        textInput.text = textBefore;
	    trace("TEXT: " + text + "; textArea.text: " + textInput.text + "; after super updateDL.");
	    ...
	    if(dropdown)
		{
		    ...
		    else if(typedText && typedText != textInput.text) 
