 ...
 package AerSysCo.Server
{
  ...
  public class SaveShoppingCartMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShoppingCartMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShoppingCart);
    }
    ...
    {
       var e:SaveShoppingCartResultEvent = new SaveShoppingCartResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,cart:ShoppingCart):void
    {
       ...
       var sendArray:Array = getSendArray(context,cart);
