 ...
 package AerSysCo.Server
{
  ...
  public class GetSalesRepMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetSalesRepMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetSalesRep);
    }
    ...
    {
       var e:GetSalesRepResultEvent = new GetSalesRepResultEvent(result.result);
       this.dispatchEvent(e);
