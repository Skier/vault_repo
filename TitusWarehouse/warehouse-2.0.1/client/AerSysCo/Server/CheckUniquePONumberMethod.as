 ...
 package AerSysCo.Server
{
  ...
  public class CheckUniquePONumberMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function CheckUniquePONumberMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.CheckUniquePONumber);
    }
    ...
    {
       var e:CheckUniquePONumberResultEvent = new CheckUniquePONumberResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,customerId:int,poNumber:String):void
    {
       ...
       var sendArray:Array = getSendArray(context,customerId,poNumber);
