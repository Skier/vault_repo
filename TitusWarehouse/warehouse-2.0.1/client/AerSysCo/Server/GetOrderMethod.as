 ...
 package AerSysCo.Server
{
  ...
  public class GetOrderMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetOrderMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetOrder);
    }
    ...
    {
       var e:GetOrderResultEvent = new GetOrderResultEvent(result.result);
       this.dispatchEvent(e);
