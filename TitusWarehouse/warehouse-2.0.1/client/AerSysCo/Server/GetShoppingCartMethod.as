 ...
 package AerSysCo.Server
{
  ...
  public class GetShoppingCartMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetShoppingCartMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetShoppingCart);
    }
    ...
    {
       var e:GetShoppingCartResultEvent = new GetShoppingCartResultEvent(result.result);
       this.dispatchEvent(e);
