 ...
 package AerSysCo.Server
{
  ...
  public class SaveShoppingCartShipmentsMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShoppingCartShipmentsMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShoppingCartShipments);
    }
    ...
    {
       var e:SaveShoppingCartShipmentsResultEvent = new SaveShoppingCartShipmentsResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,shipments:ShoppingCartShipmentCollection,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,shipments.toArray(),version);
