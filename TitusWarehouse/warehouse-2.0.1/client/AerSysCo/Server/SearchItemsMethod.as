 ...
 package AerSysCo.Server
{
  ...
  public class SearchItemsMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SearchItemsMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SearchItems);
    }
    ...
    {
       var e:SearchItemsResultEvent = new SearchItemsResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,customerId:int,search:String):void
    {
       ...
       var sendArray:Array = getSendArray(context,customerId,search);
