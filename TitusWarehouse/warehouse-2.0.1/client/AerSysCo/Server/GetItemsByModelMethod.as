 ...
 package AerSysCo.Server
{
  ...
  public class GetItemsByModelMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetItemsByModelMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetItemsByModel);
    }
    ...
    {
       var e:GetItemsByModelResultEvent = new GetItemsByModelResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,customerId:int,modelId:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,customerId,modelId);
