 ...
 package AerSysCo.Server
{
  ...
  public class GetCatalogPackageMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetCatalogPackageMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetCatalogPackage);
    }
    ...
    {
       var e:GetCatalogPackageResultEvent = new GetCatalogPackageResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context):void
    {
       ...
       var sendArray:Array = getSendArray(context);
