 ...
 package AerSysCo.Server
{
  ...
  public class SaveShoppingCartDetailsMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShoppingCartDetailsMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShoppingCartDetails);
    }
    ...
    {
       var e:SaveShoppingCartDetailsResultEvent = new SaveShoppingCartDetailsResultEvent(result.result);
       this.dispatchEvent(e);
