 ...
 package AerSysCo.Server
{
  ...
  public class GetAddressesByCustomerIdMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetAddressesByCustomerIdMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetAddressesByCustomerId);
    }
    ...
    {
       var e:GetAddressesByCustomerIdResultEvent = new GetAddressesByCustomerIdResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,customerId:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,customerId);
