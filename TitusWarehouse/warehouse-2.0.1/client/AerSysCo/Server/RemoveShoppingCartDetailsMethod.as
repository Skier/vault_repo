 ...
 package AerSysCo.Server
{
  ...
  public class RemoveShoppingCartDetailsMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function RemoveShoppingCartDetailsMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.RemoveShoppingCartDetails);
    }
    ...
    {
       var e:RemoveShoppingCartDetailsResultEvent = new RemoveShoppingCartDetailsResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,details:ShoppingCartDetailCollection,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,details.toArray(),version);
