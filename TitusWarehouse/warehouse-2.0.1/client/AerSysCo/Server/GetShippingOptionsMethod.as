 ...
 package AerSysCo.Server
{
  ...
  public class GetShippingOptionsMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetShippingOptionsMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetShippingOptions);
    }
    ...
    {
       var e:GetShippingOptionsResultEvent = new GetShippingOptionsResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,cartId:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,cartId);
