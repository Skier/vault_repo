 ...
 package AerSysCo.Server
{
  ...
  public class LoginMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function LoginMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.Login);
    }
    ...
    {
       var e:LoginResultEvent = new LoginResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(username:String,password:String):void
    {
       ...
       var sendArray:Array = getSendArray(username,password);
