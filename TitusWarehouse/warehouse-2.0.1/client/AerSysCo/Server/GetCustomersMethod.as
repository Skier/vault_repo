 ...
 package AerSysCo.Server
{
  ...
  public class GetCustomersMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetCustomersMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetCustomers);
    }
    ...
    {
       var e:GetCustomersResultEvent = new GetCustomersResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(user:ASCUser):void
    {
       ...
       var sendArray:Array = getSendArray(user);
