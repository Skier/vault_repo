 ...
 package AerSysCo.Server
{
  ...
  public class SaveShippingAddressMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShippingAddressMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShippingAddress);
    }
    ...
    {
       var e:SaveShippingAddressResultEvent = new SaveShippingAddressResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,address:ShippingAddress):void
    {
       ...
       var sendArray:Array = getSendArray(context,address);
