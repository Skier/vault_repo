 ...
 package AerSysCo.Server
{
  ...
  public class GetItemsByCategoryMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetItemsByCategoryMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetItemsByCategory);
    }
    ...
    {
       var e:GetItemsByCategoryResultEvent = new GetItemsByCategoryResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,customerId:int,categoryId:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,customerId,categoryId);
