 ...
 package AerSysCo.Server
{
  ...
  public class CheckInShoppingCartMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function CheckInShoppingCartMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.CheckInShoppingCart);
    }
    ...
    {
       var e:CheckInShoppingCartResultEvent = new CheckInShoppingCartResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,cartId:int,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,cartId,version);
