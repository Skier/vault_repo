 ...
 package AerSysCo.Server
{
  ...
  public class GetCustomerMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetCustomerMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetCustomer);
    }
    ...
    {
       var e:GetCustomerResultEvent = new GetCustomerResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(id:int):void
    {
       ...
       var sendArray:Array = getSendArray(id);
