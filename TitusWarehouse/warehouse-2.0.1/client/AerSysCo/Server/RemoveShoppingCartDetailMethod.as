 ...
 package AerSysCo.Server
{
  ...
  public class RemoveShoppingCartDetailMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function RemoveShoppingCartDetailMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.RemoveShoppingCartDetail);
    }
    ...
    {
       var e:RemoveShoppingCartDetailResultEvent = new RemoveShoppingCartDetailResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,shoppingCartDetailId:int,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,shoppingCartDetailId,version);
