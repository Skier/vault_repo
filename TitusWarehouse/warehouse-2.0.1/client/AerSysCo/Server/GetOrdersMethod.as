 ...
 package AerSysCo.Server
{
  ...
  public class GetOrdersMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function GetOrdersMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.GetOrders);
    }
    ...
    {
       var e:GetOrdersResultEvent = new GetOrdersResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,filter:OrderFilter):void
    {
       ...
       var sendArray:Array = getSendArray(context,filter);
