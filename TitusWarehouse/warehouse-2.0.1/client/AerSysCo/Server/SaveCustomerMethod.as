 ...
 package AerSysCo.Server
{
  ...
  public class SaveCustomerMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveCustomerMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveCustomer);
    }
    ...
    {
       var e:SaveCustomerResultEvent = new SaveCustomerResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(user:ASCUser,customer:Customer):void
    {
       ...
       var sendArray:Array = getSendArray(user,customer);
