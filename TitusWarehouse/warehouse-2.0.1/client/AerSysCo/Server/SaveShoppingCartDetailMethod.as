 ...
 package AerSysCo.Server
{
  ...
  public class SaveShoppingCartDetailMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShoppingCartDetailMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShoppingCartDetail);
    }
    ...
    {
       var e:SaveShoppingCartDetailResultEvent = new SaveShoppingCartDetailResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,detail:ShoppingCartDetail,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,detail,version);
