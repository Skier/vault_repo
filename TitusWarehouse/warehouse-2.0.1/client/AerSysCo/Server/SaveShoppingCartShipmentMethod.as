 ...
 package AerSysCo.Server
{
  ...
  public class SaveShoppingCartShipmentMethod extends EventDispatcher
  {
    private var ws:WebService;
    private var operation:AbstractOperation;

    public function SaveShoppingCartShipmentMethod(webService:WebService)
    {
        this.ws = webService;
        this.operation = ws.getOperation(WebServiceMethodName.SaveShoppingCartShipment);
    }
    ...
    {
       var e:SaveShoppingCartShipmentResultEvent = new SaveShoppingCartShipmentResultEvent(result.result);
       this.dispatchEvent(e);
    ...
    public function send(context:Context,shipment:ShoppingCartShipment,version:int):void
    {
       ...
       var sendArray:Array = getSendArray(context,shipment,version);
