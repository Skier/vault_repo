...
{
    partial class ReportConstructionManagerView
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            this.m_colAmountBilled = new DevExpress.XtraGrid.Columns.GridColumn();
            this.m_colAmountReceived = new DevExpress.XtraGrid.Columns.GridColumn();
            this.m_colJobCost = new DevExpress.XtraGrid.Columns.GridColumn();
            this.m_colProfit = new DevExpress.XtraGrid.Columns.GridColumn();
            this.m_colProfitPercentage = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.gridColumn3,
            this.gridColumn4,
            this.m_colAmountBilled,
            this.m_colAmountReceived,
            this.m_colJobCost,
            this.m_colProfit,
            this.m_colProfitPercentage});
            this.m_gridView.GridControl = this.m_grid;
            this.m_gridView.GroupCount = 1;
            this.m_gridView.GroupSummary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "BilledAmount", this.m_colAmountBilled, "{0:C2}"),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "ReceivedAmount", this.m_colAmountReceived, "{0:C2}"),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Custom, "JobCost", this.m_colJobCost, "{0:C2}"),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Custom, "ProfitAmount", this.m_colProfit, "{0:C2}"),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Custom, "ProfitPercent", this.m_colProfitPercentage, "{0:P0}")});
            ...
            // gridColumn4
            // 
            this.gridColumn4.Caption = "Closed";
            this.gridColumn4.DisplayFormat.FormatString = "d";
            this.gridColumn4.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            this.gridColumn4.FieldName = "ClosedDate";
            ...
            // m_colAmountBilled
            // 
            this.m_colAmountBilled.Caption = "Amount Billed";
            this.m_colAmountBilled.DisplayFormat.FormatString = "C";
            this.m_colAmountBilled.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.m_colAmountBilled.FieldName = "BilledAmount";
            this.m_colAmountBilled.Name = "m_colAmountBilled";
            this.m_colAmountBilled.OptionsColumn.AllowEdit = false;
            this.m_colAmountBilled.SummaryItem.DisplayFormat = "{0:C2}";
            this.m_colAmountBilled.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            this.m_colAmountBilled.Visible = true;
            this.m_colAmountBilled.VisibleIndex = 3;
            // 
            // m_colAmountReceived
            // 
            this.m_colAmountReceived.Caption = "Amount Received";
            this.m_colAmountReceived.DisplayFormat.FormatString = "C";
            this.m_colAmountReceived.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.m_colAmountReceived.FieldName = "ReceivedAmount";
            this.m_colAmountReceived.Name = "m_colAmountReceived";
            this.m_colAmountReceived.OptionsColumn.AllowEdit = false;
            this.m_colAmountReceived.SummaryItem.DisplayFormat = "{0:C2}";
            this.m_colAmountReceived.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            this.m_colAmountReceived.Visible = true;
            this.m_colAmountReceived.VisibleIndex = 4;
            // 
            // m_colJobCost
            // 
            this.m_colJobCost.Caption = "Job Cost";
            this.m_colJobCost.DisplayFormat.FormatString = "C";
            this.m_colJobCost.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.m_colJobCost.FieldName = "JobCost";
            this.m_colJobCost.Name = "m_colJobCost";
            this.m_colJobCost.OptionsColumn.AllowEdit = false;
            this.m_colJobCost.SummaryItem.DisplayFormat = "{0:C2}";
            this.m_colJobCost.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Custom;
            this.m_colJobCost.Visible = true;
            this.m_colJobCost.VisibleIndex = 5;
            // 
            // m_colProfit
            // 
            this.m_colProfit.Caption = "Profit";
            this.m_colProfit.DisplayFormat.FormatString = "C";
            this.m_colProfit.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.m_colProfit.FieldName = "ProfitAmount";
            this.m_colProfit.Name = "m_colProfit";
            this.m_colProfit.OptionsColumn.AllowEdit = false;
            this.m_colProfit.SummaryItem.DisplayFormat = "{0:C2}";
            this.m_colProfit.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Custom;
            this.m_colProfit.Visible = true;
            this.m_colProfit.VisibleIndex = 6;
            // 
            // m_colProfitPercentage
            // 
            this.m_colProfitPercentage.Caption = "%";
            this.m_colProfitPercentage.DisplayFormat.FormatString = "P0";
            this.m_colProfitPercentage.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.m_colProfitPercentage.FieldName = "ProfitPercent";
            this.m_colProfitPercentage.Name = "m_colProfitPercentage";
            this.m_colProfitPercentage.OptionsColumn.AllowEdit = false;
            this.m_colProfitPercentage.SummaryItem.DisplayFormat = "{0:P0}";
            this.m_colProfitPercentage.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Custom;
            this.m_colProfitPercentage.Visible = true;
            this.m_colProfitPercentage.VisibleIndex = 7;
            // 
            ...
            // 
            // ReportConstructionManagerView
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.Controls.Add(this.m_pnlReportContent);
            this.Name = "ReportConstructionManagerView";
        ...
        internal DevExpress.XtraGrid.Columns.GridColumn m_colJobCost;
        internal DevExpress.XtraGrid.Columns.GridColumn m_colAmountBilled;
        internal DevExpress.XtraGrid.Columns.GridColumn m_colAmountReceived;
        internal DevExpress.XtraGrid.Columns.GridColumn m_colProfit;
        internal DevExpress.XtraGrid.Columns.GridColumn m_colProfitPercentage;        
    }
}
