...
namespace Dalworth.Server.Domain.package {
    ...
    public class VisitReport : ReportClass {
    ...
    public class CachedVisitReport : Component, ICachedReport {
        
        public CachedVisitReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            VisitReport rpt = new VisitReport();
            rpt.Site = this.Site;
            return rpt;
        }
