...
<head>
<title>Contact Us [Service Solutions Inc.]</title>
          ...
          <td>
            <table cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td></td>
                <td class="top-menu-panel"><img src="images/contact_bw.gif" width="25" height="16" border="0"></td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="top-menu-panel">|</td>
                <td class="top-menu-panel-selected">&nbsp;&nbsp;&nbsp;ContactUs&nbsp;&nbsp;&nbsp;</td>
                <td class="top-menu-panel">|</td>
              </tr>
              <tr>
                <td colspan="5"><img src="images/bg.gif" width="10" height="4"></td>
              ...
              <tr class="3px-height">
                <td colspan="2"></td>
                <td colspan="3"><table cellpadding="0" cellspacing="0" class="selected-cell"><tr><td><img src="images/bg.gif" width="10" height="2"></td></tr></table></td>
              </tr>
            </table>
          </td>
                      ...
                      <td valign="bottom">
                        <table cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            ...
                            <td nowrap><img src="images/bg.gif" width="15" height="2"></td>
                            <td nowrap><a href="technologies.html" class="main-menu">[ Capabilities ]</a></td>
                            <td nowrap><img src="images/bg.gif" width="15" height="2"></td>
                          ...
                          <tr>
                            <td colspan="13"><img src="images/bg.gif" width="10" height="18"></td>
                          </tr>
                          <tr>
                            <td colspan="13"><img src="images/bg.gif" width="10" height="10"></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
...
<table cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="5"><img src="images/bg.gif" width="50" height="50"></td>
  </tr>
  <tr>
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="100%">
              <table cellpadding="0" cellspacing="0">
                <tr valign="top">
                  <td colspan="3" class="form-title">You can reach us:</td>
                </tr>
                <tr valign="top">
                  <td colspan="3"><? echo ("php working ok!");?><img src="images/bg.gif" width="10" height="5"></td>
                </tr>
                <tr valign="top">
                  <td nowrap class="plaintext">By mail</td>
                  <td nowrap class="plaintext" style="text-align:right;"> - - - - - - - - - - - - - -&nbsp;</td>
                  <td width="100%" class="plaintext">1505 LBJ Freeway <br>Suite 500, <br>Dallas, Texas 75234</td>
                </tr>
                <tr valign="top">
                  <td nowrap class="plaintext">By phone</td>
                  <td nowrap class="plaintext" style="text-align:right;"> - - - - - - - - - - - - -&nbsp;</td>
                  <td width="100%" class="plaintext">214-335-4143</td>
                </tr>
                <tr valign="top">
                  <td nowrap class="plaintext">By e-mail</td>
                  <td nowrap class="plaintext" style="text-align:right;"> - - - - - - - - - - - - -&nbsp;</td>
                  <td width="100%" class="plaintext"><a href="mailto:info@servicesolutionsco.com" style="font-size:12px;">info@servicesolutionsco.com</a></td>
                </tr>
                <tr valign="top">
                  <td colspan="3"><img src="images/bg.gif" width="20" height="20"></td>
                </tr>
                <tr valign="top" style="display:none;">
                  <td colspan="3" class="form-title">By filling out the information below</td>
                </tr>
                <tr valign="top" style="display:none;">
                  <td colspan="3">
                    <table cellpadding="0" cellspacing="3">
                      <tr valign="top">
                        ...
                        <td><input name="name" style="width:115px;" maxlength="50"></td>
                        <td><img src="images/bg.gif" width="40" height="5"></td>
                        <td class="field-name">Company &nbsp;</td>
                        <td><input name="company" style="width:115px;" maxlength="50"></td>
                      </tr>
                      <tr valign="top">
                        <td colspan="5"><img src="images/bg.gif" width="5" height="5"></td>
                      </tr>
                      <tr valign="top">
                        <td class="field-name">Email</td>
                        <td><input name="email" style="width:115px;" maxlength="150"></td>
                        <td><img src="images/bg.gif" width="40" height="5"></td>
                        <td class="field-name">Phone</td>
                        <td><input name="phone" style="width:115px;" maxlength="50"></td>
                      </tr>
                      <tr valign="top">
                        <td colspan="5"><img src="images/bg.gif" width="5" height="10"></td>
                      </tr>
                      <tr valign="top">
                        <td class="field-name">Subject</td>
                        <td colspan="3"><input name="name" style="width:100%;" maxlength="200"></td>
                        <td><img src="images/bg.gif" width="5" height="5"></td>
                      </tr>
                      <tr valign="top">
                        <td class="field-name">Comment</td>
                        <td colspan="4"><textarea name="name" style="width:100%;height:105px;"></textarea></td>
                      </tr>
                    </table>
                  </td>
                </tr>
    ...
    <td><img src="images/bg.gif" width="10" height="2"></td>
  </tr>
</table>
<!-- content end -->
...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <td>
      <table cellpadding="0" cellspacing="0">
        ...
        <tr class="bottom-line">
          <td colspan="13"><img src="images/bg.gif" width="9" height="9"></td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    <td nowrap><img src="images/bg.gif" width="117" height="9"><span 
      ...
      >&copy; 2007, Service Solutions Inc. </span><span 
