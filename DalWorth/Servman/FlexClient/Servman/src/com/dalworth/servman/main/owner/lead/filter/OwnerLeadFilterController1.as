package com.dalworth.servman.main.owner.lead.filter
{
	...
	public class OwnerLeadFilterController1
	{
		private var view:UIComponent;
		private var model:OwnerLeadFilterModel;
		
		public function OwnerLeadFilterController1(view:UIComponent)
		{
			this.view = view;
			this.model = OwnerLeadFilterModel.getInstance();
		}
