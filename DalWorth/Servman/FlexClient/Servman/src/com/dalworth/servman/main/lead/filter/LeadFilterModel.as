package com.dalworth.servman.main.lead.filter
{
	...
	public class LeadFilterModel
	{
		...
		private static var _instance:LeadFilterModel;
		public static function getInstance():LeadFilterModel
		{
			if (_instance == null)
				_instance = new LeadFilterModel(new Private());
			
			return _instance;
		}
		
		public function LeadFilterModel(accessPrivate:Private) 
		{
