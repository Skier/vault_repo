...
do
  ...
  grtV.setGlobal("/migration/sourceConnection", {
    ...
    parameterValues= {
      database= "servman_main",
      domain= "",
      host= "VALERY-8730W",
      jdbcConnStr= "jdbc:jtds:sqlserver://VALERY-8730W;user=root_main;password=gfhjkm;namedPipe=true;",
      password= "gfhjkm",
      port= "1433",
      username= "root_main"
    },
...
do
  ...
  grtV.setGlobal("/migration/mappingDefaults", {
    {
        _id = "{73A061A5-8037-4EC7-9E96-68F2FC220C6D}", 
        method = "33f69e9f8d2612da:7f2f244b:12a7f6cbed4:-7f787f2f244b:12a7f6cbed4:-7f77", 
    ...
    {
        _id = "{B767F199-E188-445D-916A-ECDE147553A1}", 
        method = "33f69e9f8d2612da:7f2f244b:12a7f6cbed4:-7f887f2f244b:12a7f6cbed4:-7f87", 
    ...
    {
        _id = "{14D18A13-95AB-4CBC-92BA-4BC69025A7EC}", 
        method = "33f69e9f8d2612da:7f2f244b:12a7f6cbed4:-7f8e7f2f244b:12a7f6cbed4:-7f8d", 
