...
INSERT INTO `transaction` (`Id`, `TransactionDate`, `TransactionTypeId`, `Quantity`, `Amount`, `CurrentBalance`) VALUES
(1,'2011-01-01',9,1,25,25),
(2,'2011-01-05',10,1,15,40);

INSERT INTO `user` (`Id`, `QbUserId`, `Email`, `Name`, `FirstName`, `LastName`, `Phone`, `Address`, `PhotoFileId`, `IsActive`,`RoleName`) VALUES (1,'55521507.ds33','valery@affilia.com','Valery Yaworsky','Valery','Yaworsky','+12143354143',NULL,NULL,1,'Administrator');
