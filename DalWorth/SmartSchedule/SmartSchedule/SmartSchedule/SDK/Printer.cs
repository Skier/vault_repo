...
namespace SmartSchedule.SDK
{
    public class Printer : IDisposable
    {
        ...
        public delegate void StartNewPageHandler(Printer printer, int pageNumber);
        public event StartNewPageHandler StartNewPage;

        private int m_currentPrintLine;
        ...
        public void WriteLine()
        {
            if (Active)
            {
                ...
                if (m_currentPrintLine % PAGE_LENGHT_IN_LINES == 0)
                {
                    GoToNextPage();
                    if (StartNewPage != null)
                        StartNewPage(this, m_currentPrintLine / PAGE_LENGHT_IN_LINES + 1);
                }
            }
        }
        ...
        {
            WriteUnescaped(@"\x1B\x34");
        }

        public void EndItalic()
        {
            WriteUnescaped(@"\x1B\x35");
        }
