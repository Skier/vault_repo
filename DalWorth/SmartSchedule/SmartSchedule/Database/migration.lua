...
do
  ...
  grtV.setGlobal("/migration/sourceConnection", {
    ...
    parameterValues= {
      ...
      domain= "",
      host= "127.0.0.1",
      jdbcConnStr= "jdbc:jtds:sqlserver://127.0.0.1;user=smartschd;password=gfhjkm;namedPipe=true",
      password= "gfhjkm",
      port= "1433",
      username= "smartschd"
    },
...
do
  ...
  grtV.setGlobal("/migration/mappingDefaults", {
    {
        _id = "{CE01B9E5-3E16-4E7B-84B6-AC484BF2D0B9}", 
        method = "6efb05edcd9533d7:-5aad86bc:121cac9439a:-7f1c-5aad86bc:121cac9439a:-7f1b", 
    ...
    {
        _id = "{0EA917CA-5DB5-4E4D-AEA1-4097F4D0161E}", 
        method = "6efb05edcd9533d7:-5aad86bc:121cac9439a:-7f20-5aad86bc:121cac9439a:-7f1f", 
    ...
    {
        _id = "{28132145-4D89-4B5E-BE4E-A39BADB5BE75}", 
        method = "6efb05edcd9533d7:-5aad86bc:121cac9439a:-7f2c-5aad86bc:121cac9439a:-7f2b", 
    ...
    {
        _id = "{D3443BC1-BDFF-426B-9FE8-409467F973F6}", 
        method = "6efb05edcd9533d7:-5aad86bc:121cac9439a:-7f32-5aad86bc:121cac9439a:-7f31", 
