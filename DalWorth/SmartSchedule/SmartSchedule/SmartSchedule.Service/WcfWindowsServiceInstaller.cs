...
{
    [RunInstaller(true)]
    public class WcfWindowsServiceInstaller : Installer
    {
        ...
        public WcfWindowsServiceInstaller()
        {
            ...
            m_serviceInstaller.DisplayName = "SmartSchedule WCF Service";
            ...
            m_serviceInstaller.ServiceName = "SmartSchedule WCF Service";
