package com.dalworth.leadCentral.dashboard.calls
{
	...
	public class DashboardCallsController
	{
		private var model:DashboardCallsModel;
		private var view:UIComponent;
		
		public function DashboardCallsController(view:UIComponent)
		{
			this.view = view;
			this.model = DashboardCallsModel.getInstance();
		}
