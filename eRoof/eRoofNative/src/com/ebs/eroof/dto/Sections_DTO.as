package com.ebs.eroof.dto
{
	...
	public class Sections_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		...
		public function get Restorable():Boolean						{return _fields["_Restorable"];}
		public function get Restorable_isDirty():Boolean				{return _fields["_Restorable_isDirty"];}
		public function get Drainage():String							{return _fields["_Drainage"];}
		public function get Drainage_isDirty():Boolean					{return _fields["_Drainage_isDirty"];}
		...
		public function set Restorable(val:Boolean):void				{_fields["_Restorable"] = val; _fields["_Restorable_isDirty"] = true;}
		public function set Drainage(val:String):void					{_fields["_Drainage"] = val; _fields["_Drainage_isDirty"] = true;}
		...
		private function set IDNRestorable(val:String):void				{_fields["_Restorable"] = Boolean(Number(val));}
		...
		public function get Restorable_Info():BooleanField				{return Sections_Info.getInstance().Restorable_Info;}
		public function get Drainage_Info():TextField					{return Sections_Info.getInstance().Drainage_Info;}
