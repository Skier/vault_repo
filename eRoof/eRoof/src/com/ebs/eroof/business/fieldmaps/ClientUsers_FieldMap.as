package com.ebs.eroof.business.fieldmaps
{
	...
	public class ClientUsers_FieldMap extends QuickBaseFieldMap implements IQuickBaseFieldMap
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		public function ClientUsers_FieldMap()
		{
			super();
		}
		...
		{
			columnFids.ClientUser = 8;
			columnFids.rid = 3;
			columnFids.RelatedClient = 6;
			columnFids.Client = 9;
			columnFids.AllowedClientUser = 10;
