package com.ebs.eroof.business.fieldmaps
{
	...
	public class SurveyPhotos_FieldMap extends QuickBaseFieldMap implements IQuickBaseFieldMap
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		public function SurveyPhotos_FieldMap()
		{
			super();
		}
		...
		protected override function loadFids():void
		{
			...
			columnFids.PhotoThumbnail = 25;
			columnFids.AllowedUser = 26;
			columnFids.IRPPhotoFileName = 27;
