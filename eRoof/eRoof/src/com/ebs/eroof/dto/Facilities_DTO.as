package com.ebs.eroof.dto
{
	...
	public class Facilities_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		...
		public function get FacilityUsers():String						{return _fields["_FacilityUsers"];}
		public function get FacilityUsers_isDirty():Boolean				{return _fields["_FacilityUsers_isDirty"];}
		public function get AddFacilityUser():String					{return _fields["_AddFacilityUser"];}
		public function get AddFacilityUser_isDirty():Boolean			{return _fields["_AddFacilityUser_isDirty"];}
		...
		public function get SitePlanLatLong():String					{return _fields["_SitePlanLatLong"];}
		public function get SitePlanLatLong_isDirty():Boolean			{return _fields["_SitePlanLatLong_isDirty"];}
		...
		public function set SitePlanLatLong(val:String):void			{_fields["_SitePlanLatLong"] = val; _fields["_SitePlanLatLong_isDirty"] = true;}
		...
		private function set IDNFacilityUsers(val:String):void			{_fields["_FacilityUsers"] = val;}
		private function set IDNAddFacilityUser(val:String):void		{_fields["_AddFacilityUser"] = val;}
		...
		private function set IDNSitePlanLatLong(val:String):void		{_fields["_SitePlanLatLong"] = val;}
		...
		public function get FacilityUsers_Info():DbLinkField			{return Facilities_Info.getInstance().FacilityUsers_Info;}
		public function get AddFacilityUser_Info():URLField				{return Facilities_Info.getInstance().AddFacilityUser_Info;}
		...
		public function get AllowedFacilityUser_Info():NumberField		{return Facilities_Info.getInstance().AllowedFacilityUser_Info;}
		...
		public function get MapLatLong_Info():TextField					{return Facilities_Info.getInstance().MapLatLong_Info;}
		public function get MapZoom_Info():NumberField					{return Facilities_Info.getInstance().MapZoom_Info;}
		...
		public function get SitePlanLatLong_Info():TextField			{return Facilities_Info.getInstance().SitePlanLatLong_Info;}
