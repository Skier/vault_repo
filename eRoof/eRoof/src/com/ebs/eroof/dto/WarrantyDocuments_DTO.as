package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.WarrantyDocuments_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class WarrantyDocuments_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		public function get RelatedWarranty():Number					{return _fields["_RelatedWarranty"];}
		public function get RelatedWarranty_isDirty():Boolean			{return _fields["_RelatedWarranty_isDirty"];}
		...
		public function set RelatedWarranty(val:Number):void			{_fields["_RelatedWarranty"] = val; _fields["_RelatedWarranty_isDirty"] = true;}
		...
		private function set IDNRelatedWarranty(val:String):void		{_fields["_RelatedWarranty"] = Number(val);}
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return WarrantyDocuments_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new WarrantyDocuments_FieldMap();}
		public function getFieldMapClass():Class						{return WarrantyDocuments_FieldMap;}
		public function get dtoClass():Class							{return WarrantyDocuments_DTO;}

		// MetaData Information Objects getters
		public function get RelatedWarranty_Info():NumberField			{return WarrantyDocuments_Info.getInstance().RelatedWarranty_Info;}
		public function get Client_Info():TextField						{return WarrantyDocuments_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return WarrantyDocuments_Info.getInstance().Facility_Info;}
		public function get Roof_Info():TextField						{return WarrantyDocuments_Info.getInstance().Roof_Info;}
		public function get Title_Info():TextField						{return WarrantyDocuments_Info.getInstance().Title_Info;}
		public function get Description_Info():TextField				{return WarrantyDocuments_Info.getInstance().Description_Info;}
		public function get Date_Info():DateField						{return WarrantyDocuments_Info.getInstance().Date_Info;}
		public function get Document_Info():FileField					{return WarrantyDocuments_Info.getInstance().Document_Info;}
		public function get AllowedClientUser_Info():NumberField		{return WarrantyDocuments_Info.getInstance().AllowedClientUser_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return WarrantyDocuments_Info.getInstance().AllowedFacilityUser_Info;}
		public function get AllowedSectionUser_Info():NumberField		{return WarrantyDocuments_Info.getInstance().AllowedSectionUser_Info;}
		public function get AllowedUser_Info():NumberField				{return WarrantyDocuments_Info.getInstance().AllowedUser_Info;}
		public function get DateCreated_Info():TimeStampField			{return WarrantyDocuments_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return WarrantyDocuments_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return WarrantyDocuments_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return WarrantyDocuments_Info.getInstance().LastModifiedBy_Info;}
