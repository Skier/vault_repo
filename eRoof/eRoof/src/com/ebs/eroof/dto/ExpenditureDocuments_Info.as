package com.ebs.eroof.dto
{
	...
	public class ExpenditureDocuments_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:ExpenditureDocuments_Info = null;

		function ExpenditureDocuments_Info(forcePrivateClass:Private)
		{
			...
			field.fieldHelp = "";
			field.lusFid = 0;
			field.label = "Related Expenditure";
			...
			field.tableName = "ExpenditureDocuments";
			field.blankIsZero = true;
			field.role = ENRole.NotFound;
			field.fieldName = "RelatedExpenditure";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_RelatedExpenditureInfo = new NumberField(field);
			_fieldInfo.addItem(_RelatedExpenditureInfo);
		...
		public static function getInstance():ExpenditureDocuments_Info
		{
			if(_instance == null)
				_instance = new ExpenditureDocuments_Info(new Private);
			return _instance;
		}

		public function get tableName():String
		{
			return "ExpenditureDocuments";
		}
		...
		private var _RelatedExpenditureInfo:NumberField;
		...
		public function get RelatedExpenditure_Info():NumberField		{return _RelatedExpenditureInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["RelatedExpenditure", "Client", "Facility", "Roof", "Document", 
																		"Title", "Description", "Date", "AllowedClientUser", "AllowedFacilityUser", "AllowedSectionUser", 
