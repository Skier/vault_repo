package com.ebs.eroof.dto
{
	...
	public class InspectionPhotos_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:InspectionPhotos_Info = null;

		function InspectionPhotos_Info(forcePrivateClass:Private)
		{
			...
			field.tableName = "InspectionPhotos";
			field.blankIsZero = true;
			field.role = ENRole.NotFound;
			field.fieldName = "RelatedInspection";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_RelatedInspectionInfo = new NumberField(field);
			_fieldInfo.addItem(_RelatedInspectionInfo);
			...
			field.required = false;
			field.formula = "If ([Photo]=\"\",\"\",\"<a href='https://www.quickbase.com/up/\" & Dbid() & \"/a/r\" & [Record ID#] & \"/e9/va/\" & [Photo] & \"' target=_blank>\"";
			field.foreignKey = 0;
			field.findEnabled = true;
			...
			field.tableName = "InspectionPhotos";
			field.role = ENRole.NotFound;
			field.fieldName = "IRPPhotoSetID";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_IRPPhotoSetIDInfo = new TextField(field);
			_fieldInfo.addItem(_IRPPhotoSetIDInfo);
		...
		public static function getInstance():InspectionPhotos_Info
		{
			if(_instance == null)
				_instance = new InspectionPhotos_Info(new Private);
			return _instance;
		}
		...
		private var _RelatedInspectionInfo:NumberField;
		...
		private var _IRPPhotoSetIDInfo:TextField;
		...
		public function get RelatedInspection_Info():NumberField		{return _RelatedInspectionInfo;}
		...
		public function get IRPPhotoSetID_Info():TextField				{return _IRPPhotoSetIDInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["RelatedInspection", "Client", "Facility", "Roof", "Photo", 
																		"Description", "Date", "AllowedClientUser", "AllowedSectionUser", "AllowedFacilityUser", "PhotoThumbnail", 
																		"AllowedUser", "IRPPhotoSetID", "DateCreated", "DateModified", "RecordOwner", "LastModifiedBy", ]);
