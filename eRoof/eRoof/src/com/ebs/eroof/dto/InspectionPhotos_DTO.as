package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.InspectionPhotos_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class InspectionPhotos_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		public function get RelatedInspection():Number					{return _fields["_RelatedInspection"];}
		public function get RelatedInspection_isDirty():Boolean			{return _fields["_RelatedInspection_isDirty"];}
		...
		public function get IRPPhotoSetID():String						{return _fields["_IRPPhotoSetID"];}
		public function get IRPPhotoSetID_isDirty():Boolean				{return _fields["_IRPPhotoSetID_isDirty"];}
		...
		public function set RelatedInspection(val:Number):void			{_fields["_RelatedInspection"] = val; _fields["_RelatedInspection_isDirty"] = true;}
		...
		public function set IRPPhotoSetID(val:String):void				{_fields["_IRPPhotoSetID"] = val; _fields["_IRPPhotoSetID_isDirty"] = true;}
		...
		private function set IDNRelatedInspection(val:String):void		{_fields["_RelatedInspection"] = Number(val);}
		...
		private function set IDNIRPPhotoSetID(val:String):void			{_fields["_IRPPhotoSetID"] = val;}
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return InspectionPhotos_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new InspectionPhotos_FieldMap();}
		public function getFieldMapClass():Class						{return InspectionPhotos_FieldMap;}
		public function get dtoClass():Class							{return InspectionPhotos_DTO;}

		// MetaData Information Objects getters
		public function get RelatedInspection_Info():NumberField		{return InspectionPhotos_Info.getInstance().RelatedInspection_Info;}
		public function get Client_Info():TextField						{return InspectionPhotos_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return InspectionPhotos_Info.getInstance().Facility_Info;}
		public function get Roof_Info():TextField						{return InspectionPhotos_Info.getInstance().Roof_Info;}
		public function get Photo_Info():FileField						{return InspectionPhotos_Info.getInstance().Photo_Info;}
		public function get Description_Info():TextField				{return InspectionPhotos_Info.getInstance().Description_Info;}
		public function get Date_Info():DateField						{return InspectionPhotos_Info.getInstance().Date_Info;}
		public function get AllowedClientUser_Info():NumberField		{return InspectionPhotos_Info.getInstance().AllowedClientUser_Info;}
		public function get AllowedSectionUser_Info():NumberField		{return InspectionPhotos_Info.getInstance().AllowedSectionUser_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return InspectionPhotos_Info.getInstance().AllowedFacilityUser_Info;}
		public function get PhotoThumbnail_Info():TextField				{return InspectionPhotos_Info.getInstance().PhotoThumbnail_Info;}
		public function get AllowedUser_Info():NumberField				{return InspectionPhotos_Info.getInstance().AllowedUser_Info;}
		public function get IRPPhotoSetID_Info():TextField				{return InspectionPhotos_Info.getInstance().IRPPhotoSetID_Info;}
		public function get DateCreated_Info():TimeStampField			{return InspectionPhotos_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return InspectionPhotos_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return InspectionPhotos_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return InspectionPhotos_Info.getInstance().LastModifiedBy_Info;}
