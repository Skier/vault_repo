package com.ebs.eroof.dto
{
	...
	public class SurveyPhotos_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:SurveyPhotos_Info = null;

		function SurveyPhotos_Info(forcePrivateClass:Private)
		{
			...
			field.tableName = "SurveyPhotos";
			field.blankIsZero = true;
			field.role = ENRole.NotFound;
			field.fieldName = "RelatedSurvey";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_RelatedSurveyInfo = new NumberField(field);
			_fieldInfo.addItem(_RelatedSurveyInfo);
		...
		public static function getInstance():SurveyPhotos_Info
		{
			if(_instance == null)
				_instance = new SurveyPhotos_Info(new Private);
			return _instance;
		}
		...
		private var _RelatedSurveyInfo:NumberField;
		...
		public function get RelatedSurvey_Info():NumberField			{return _RelatedSurveyInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["RelatedSurvey", "Client", "Facility", "Roof", "Photo", 
