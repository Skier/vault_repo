package com.ebs.eroof.dto
{
	...
	public class DefectPhotos_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:DefectPhotos_Info = null;

		function DefectPhotos_Info(forcePrivateClass:Private)
		{
			...
			field.tableName = "DefectPhotos";
			field.blankIsZero = true;
			field.role = ENRole.NotFound;
			field.fieldName = "RelatedDefect";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_RelatedDefectInfo = new NumberField(field);
			_fieldInfo.addItem(_RelatedDefectInfo);
			...
			field.required = false;
			field.formula = "If ([Photo]=\"\",\"\",\"<a href='https://www.quickbase.com/up/\" & Dbid() & \"/a/r\" & [Record ID#] & \"/e10/va/\" & [Photo] & \"' target=_blank>\"";
			field.foreignKey = 0;
			field.findEnabled = true;
		...
		public static function getInstance():DefectPhotos_Info
		{
			if(_instance == null)
				_instance = new DefectPhotos_Info(new Private);
			return _instance;
		}
		...
		private var _RelatedDefectInfo:NumberField;
		...
		public function get RelatedDefect_Info():NumberField			{return _RelatedDefectInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["RelatedDefect", "Client", "Facility", "Roof", "Photo", 
																		"Description", "Date", "AllowedClientUser", "AllowedFacilityUser", "AllowedSectionUser", "PhotoThumbnail", 
