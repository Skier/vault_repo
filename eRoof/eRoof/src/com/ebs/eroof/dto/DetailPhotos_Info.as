package com.ebs.eroof.dto
{
	...
	public class DetailPhotos_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:DetailPhotos_Info = null;

		function DetailPhotos_Info(forcePrivateClass:Private)
		{
			...
			field.role = ENRole.NotFound;
			field.fieldName = "RelatedDetail";
			field.required = false;
			field.formula = "";
			field.foreignKey = 0;
			field.findEnabled = true;
			_RelatedDetailInfo = new NumberField(field);
			_fieldInfo.addItem(_RelatedDetailInfo);
		...
		public static function getInstance():DetailPhotos_Info
		{
			if(_instance == null)
				_instance = new DetailPhotos_Info(new Private);
			return _instance;
		}
		...
		private var _RelatedDetailInfo:NumberField;
		...
		public function get RelatedDetail_Info():NumberField			{return _RelatedDetailInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["Photo", "Description", "Date", "RelatedDetail", "Client", 
																		"Facility", "Roof", "AllowedClientUser", "AllowedFacilityUser", "AllowedSectionUser", "PhotoThumbnail", 
