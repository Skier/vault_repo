package com.ebs.eroof.dto
{
	...
	public class DocumentTemplates_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:DocumentTemplates_Info = null;

		function DocumentTemplates_Info(forcePrivateClass:Private)
		{
			...
			field.tableName = "DocumentTemplates";
			field.role = ENRole.NotFound;
			field.fieldName = "DocumentTemplate";
			field.required = false;
			field.maxVersions = 3;
			field.foreignKey = 0;
			field.findEnabled = true;
			_DocumentTemplateInfo = new ChoiceField(field);
			_fieldInfo.addItem(_DocumentTemplateInfo);
		...
		public static function getInstance():DocumentTemplates_Info
		{
			if(_instance == null)
				_instance = new DocumentTemplates_Info(new Private);
			return _instance;
		}
		...
		private var _DocumentTemplateInfo:FileField;
		...
		public function get DocumentTemplate_Info():FileField			{return _DocumentTemplateInfo;}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["DocumentTemplate", "Name", "DateCreated", "DateModified", 
