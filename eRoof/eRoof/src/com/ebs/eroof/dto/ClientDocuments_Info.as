package com.ebs.eroof.dto
{
	...
	public class ClientDocuments_Info implements IKingussieInfo
	{
		// Important Note:
		//    This class was automatically generated.  If you make changes to it and
		//    subsequently run the generator tool again, all changes will be overwritten!

		private static var _instance:ClientDocuments_Info = null;

		function ClientDocuments_Info(forcePrivateClass:Private)
		{
			...
			field.tableName = "ClientDocuments";
		...
		public static function getInstance():ClientDocuments_Info
		{
			if(_instance == null)
				_instance = new ClientDocuments_Info(new Private);
			return _instance;
		}
		...
		private var _fieldNames:ArrayCollection = new ArrayCollection(["RelatedClient", "Client", "Document", "Title", "Description", 
																		"Date", "AllowedClientUser", "AllowedUser", "DateCreated", "DateModified", "RecordOwner", "LastModifiedBy", ]);
