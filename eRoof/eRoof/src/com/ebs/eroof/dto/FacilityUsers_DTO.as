package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.FacilityUsers_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class FacilityUsers_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		public function get FacilityUser():QuickBaseUserDTO 			{return _fields["_FacilityUser"];}
		public function get FacilityUser_isDirty():Boolean				{return _fields["_FacilityUser_isDirty"];}
		...
		public function set FacilityUser(val:QuickBaseUserDTO):void 	{_fields["_FacilityUser"] = val; _fields["_FacilityUser_isDirty"] = true;}
		...
		private function set IDNFacilityUser(val:String):void
		{
			if (val == null) return;
			var model:QuickBaseMSAModel = QuickBaseMSAModel.getInstance();
			_fields["_FacilityUser"] = model.appUserList.findUserID(val);
		}
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return FacilityUsers_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new FacilityUsers_FieldMap();}
		public function getFieldMapClass():Class						{return FacilityUsers_FieldMap;}
		public function get dtoClass():Class							{return FacilityUsers_DTO;}

		// MetaData Information Objects getters
		public function get FacilityUser_Info():UserIdField				{return FacilityUsers_Info.getInstance().FacilityUser_Info;}
		public function get RelatedFacility_Info():NumberField			{return FacilityUsers_Info.getInstance().RelatedFacility_Info;}
		public function get Client_Info():TextField						{return FacilityUsers_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return FacilityUsers_Info.getInstance().Facility_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return FacilityUsers_Info.getInstance().AllowedFacilityUser_Info;}
		public function get DateCreated_Info():TimeStampField			{return FacilityUsers_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return FacilityUsers_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return FacilityUsers_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return FacilityUsers_Info.getInstance().LastModifiedBy_Info;}
