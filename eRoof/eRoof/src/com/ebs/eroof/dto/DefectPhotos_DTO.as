package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.DefectPhotos_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class DefectPhotos_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		public function get RelatedDefect():Number						{return _fields["_RelatedDefect"];}
		public function get RelatedDefect_isDirty():Boolean				{return _fields["_RelatedDefect_isDirty"];}
		...
		public function set RelatedDefect(val:Number):void				{_fields["_RelatedDefect"] = val; _fields["_RelatedDefect_isDirty"] = true;}
		...
		private function set IDNRelatedDefect(val:String):void			{_fields["_RelatedDefect"] = Number(val);}
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return DefectPhotos_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new DefectPhotos_FieldMap();}
		public function getFieldMapClass():Class						{return DefectPhotos_FieldMap;}
		public function get dtoClass():Class							{return DefectPhotos_DTO;}

		// MetaData Information Objects getters
		public function get RelatedDefect_Info():NumberField			{return DefectPhotos_Info.getInstance().RelatedDefect_Info;}
		public function get Client_Info():TextField						{return DefectPhotos_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return DefectPhotos_Info.getInstance().Facility_Info;}
		public function get Roof_Info():TextField						{return DefectPhotos_Info.getInstance().Roof_Info;}
		public function get Photo_Info():FileField						{return DefectPhotos_Info.getInstance().Photo_Info;}
		public function get Description_Info():TextField				{return DefectPhotos_Info.getInstance().Description_Info;}
		public function get Date_Info():DateField						{return DefectPhotos_Info.getInstance().Date_Info;}
		public function get AllowedClientUser_Info():NumberField		{return DefectPhotos_Info.getInstance().AllowedClientUser_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return DefectPhotos_Info.getInstance().AllowedFacilityUser_Info;}
		public function get AllowedSectionUser_Info():NumberField		{return DefectPhotos_Info.getInstance().AllowedSectionUser_Info;}
		public function get PhotoThumbnail_Info():TextField				{return DefectPhotos_Info.getInstance().PhotoThumbnail_Info;}
		public function get AllowedUser_Info():NumberField				{return DefectPhotos_Info.getInstance().AllowedUser_Info;}
		public function get IRPPhotoFileName_Info():TextField			{return DefectPhotos_Info.getInstance().IRPPhotoFileName_Info;}
		public function get DateCreated_Info():TimeStampField			{return DefectPhotos_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return DefectPhotos_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return DefectPhotos_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return DefectPhotos_Info.getInstance().LastModifiedBy_Info;}
