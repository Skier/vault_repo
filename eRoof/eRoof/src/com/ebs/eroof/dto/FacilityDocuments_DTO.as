package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.FacilityDocuments_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class FacilityDocuments_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return FacilityDocuments_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new FacilityDocuments_FieldMap();}
		public function getFieldMapClass():Class						{return FacilityDocuments_FieldMap;}
		public function get dtoClass():Class							{return FacilityDocuments_DTO;}

		// MetaData Information Objects getters
		public function get RelatedFacility_Info():NumberField			{return FacilityDocuments_Info.getInstance().RelatedFacility_Info;}
		public function get Client_Info():TextField						{return FacilityDocuments_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return FacilityDocuments_Info.getInstance().Facility_Info;}
		public function get Document_Info():FileField					{return FacilityDocuments_Info.getInstance().Document_Info;}
		public function get Title_Info():TextField						{return FacilityDocuments_Info.getInstance().Title_Info;}
		public function get Description_Info():TextField				{return FacilityDocuments_Info.getInstance().Description_Info;}
		public function get Date_Info():DateField						{return FacilityDocuments_Info.getInstance().Date_Info;}
		public function get AllowedClientUser_Info():NumberField		{return FacilityDocuments_Info.getInstance().AllowedClientUser_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return FacilityDocuments_Info.getInstance().AllowedFacilityUser_Info;}
		public function get AllowedUser_Info():NumberField				{return FacilityDocuments_Info.getInstance().AllowedUser_Info;}
		public function get DateCreated_Info():TimeStampField			{return FacilityDocuments_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return FacilityDocuments_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return FacilityDocuments_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return FacilityDocuments_Info.getInstance().LastModifiedBy_Info;}
