package com.ebs.eroof.dto
{
	...
	import com.ebs.eroof.business.fieldmaps.DetailPhotos_FieldMap;
	import mx.collections.ArrayCollection;

	[Bindable]
	public class DetailPhotos_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		// Important Note:
		...
		public function get RelatedDetail():Number						{return _fields["_RelatedDetail"];}
		public function get RelatedDetail_isDirty():Boolean				{return _fields["_RelatedDetail_isDirty"];}
		...
		public function set RelatedDetail(val:Number):void				{_fields["_RelatedDetail"] = val; _fields["_RelatedDetail_isDirty"] = true;}
		...
		private function set IDNRelatedDetail(val:String):void			{_fields["_RelatedDetail"] = Number(val);}
		...
		// Object getters
		public function getInfoObj():IKingussieInfo						{return DetailPhotos_Info.getInstance();}
		public function getFieldMapObj():IQuickBaseFieldMap				{return new DetailPhotos_FieldMap();}
		public function getFieldMapClass():Class						{return DetailPhotos_FieldMap;}
		public function get dtoClass():Class							{return DetailPhotos_DTO;}

		// MetaData Information Objects getters
		public function get Photo_Info():FileField						{return DetailPhotos_Info.getInstance().Photo_Info;}
		public function get Description_Info():TextField				{return DetailPhotos_Info.getInstance().Description_Info;}
		public function get Date_Info():DateField						{return DetailPhotos_Info.getInstance().Date_Info;}
		public function get RelatedDetail_Info():NumberField			{return DetailPhotos_Info.getInstance().RelatedDetail_Info;}
		public function get Client_Info():TextField						{return DetailPhotos_Info.getInstance().Client_Info;}
		public function get Facility_Info():TextField					{return DetailPhotos_Info.getInstance().Facility_Info;}
		public function get Roof_Info():TextField						{return DetailPhotos_Info.getInstance().Roof_Info;}
		public function get AllowedClientUser_Info():NumberField		{return DetailPhotos_Info.getInstance().AllowedClientUser_Info;}
		public function get AllowedFacilityUser_Info():NumberField		{return DetailPhotos_Info.getInstance().AllowedFacilityUser_Info;}
		public function get AllowedSectionUser_Info():NumberField		{return DetailPhotos_Info.getInstance().AllowedSectionUser_Info;}
		public function get PhotoThumbnail_Info():TextField				{return DetailPhotos_Info.getInstance().PhotoThumbnail_Info;}
		public function get AllowedUser_Info():NumberField				{return DetailPhotos_Info.getInstance().AllowedUser_Info;}
		public function get IRPPhotoFileName_Info():TextField			{return DetailPhotos_Info.getInstance().IRPPhotoFileName_Info;}
		public function get DateCreated_Info():TimeStampField			{return DetailPhotos_Info.getInstance().DateCreated_Info;}
		public function get DateModified_Info():TimeStampField			{return DetailPhotos_Info.getInstance().DateModified_Info;}
		public function get RecordOwner_Info():UserIdField				{return DetailPhotos_Info.getInstance().RecordOwner_Info;}
		public function get LastModifiedBy_Info():UserIdField			{return DetailPhotos_Info.getInstance().LastModifiedBy_Info;}
