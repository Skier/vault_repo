package com.ebs.eroof.dto
{
	...
	public class Segments_DTO extends KingussieDTOBase implements IValueObject, IKingussieDTO
	{
		...
		public function get AddClient():String							{return _fields["_AddClient"];}
		public function get AddClient_isDirty():Boolean					{return _fields["_AddClient_isDirty"];}
		public function get Clients():String							{return _fields["_Clients"];}
		public function get Clients_isDirty():Boolean					{return _fields["_Clients_isDirty"];}
		public function get CalcName():String							{return _fields["_CalcName"];}
		public function get CalcName_isDirty():Boolean					{return _fields["_CalcName_isDirty"];}
		...
		private function set IDNAddClient(val:String):void				{_fields["_AddClient"] = val;}
		private function set IDNClients(val:String):void				{_fields["_Clients"] = val;}
		private function set IDNCalcName(val:String):void				{_fields["_CalcName"] = val;}
		...
		public function get AddClient_Info():URLField					{return Segments_Info.getInstance().AddClient_Info;}
		public function get Clients_Info():URLField						{return Segments_Info.getInstance().Clients_Info;}
		public function get CalcName_Info():TextField					{return Segments_Info.getInstance().CalcName_Info;}
