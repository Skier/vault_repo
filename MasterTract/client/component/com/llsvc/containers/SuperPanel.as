package com.llsvc.containers {
	...
	public class SuperPanel extends Panel {
		...
		private var resizeHandler:Canvas	= new Canvas();
...
//			this.setStyle("borderColor", 0xD2DCE2);
			...
			if (showControls) {
				...
				this.closeButton.width     		= 12;
				this.closeButton.height    		= 12;
		...
		public function positionChildren():void {
			...
			if (enableResize) {
				this.resizeHandler.y = this.unscaledHeight - resizeHandler.height - 0;
				this.resizeHandler.x = this.unscaledWidth - resizeHandler.width - 0;
			}
		}
