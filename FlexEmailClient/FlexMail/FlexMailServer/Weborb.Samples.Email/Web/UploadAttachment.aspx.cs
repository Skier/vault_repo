...
public class UploadAttachment : System.Web.UI.Page 
{
    ...
    private void ProcessRequest() {
        if (Request.Files.Count > 0) {
            ...
            List<FileInfo> messageFileList = (List<FileInfo>) flexMailServer.uploadedFilesMap[messageUid];
            ...
            flexMailServer.uploadedFilesMap[messageUid] = messageFileList;
        }
    }
