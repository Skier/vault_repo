...
namespace Weborb.Samples.Email
{
    public class ServerSettings
    {
        ...
        public static Pop3MailClient ConnectToPop3(ServerSettingsInfo info) {
            
            Pop3MailClient pop3 = new Pop3MailClient(
                info.Host,
                info.Port,
        ...
        public static SmtpClient ConnectToSmtp(ServerSettingsInfo info) {
            ...
            if (null != info.UserName && info.UserName.Length > 0 )
        ...
        public static ServerSettingsInfo Retrieve(IDbConnection connection, int settingsId) {
