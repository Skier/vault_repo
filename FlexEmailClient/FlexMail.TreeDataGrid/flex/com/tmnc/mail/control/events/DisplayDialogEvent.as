package com.tmnc.mail.control.events
{
    ...
    public class DisplayDialogEvent extends Event
    {
         ...
         **/
        public function DisplayDialogEvent(type:String, dialogParent:DisplayObject,bubbles:Boolean=true,
        ...
        public override function clone():Event {
                return new DisplayDialogEvent(type, dialogParent,bubbles,cancelable);
        }

        /** The DisplayObject which should be the parent of the dialog. */
        public var dialogParent:DisplayObject;
