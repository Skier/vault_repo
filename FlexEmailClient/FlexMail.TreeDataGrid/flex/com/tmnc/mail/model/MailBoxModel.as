...
package com.tmnc.mail.model 
{
    ...
    {       
		...
		public function clearUserState():void{
			...
			this.serversMessageCount = 0;			
			this.statusMessage = "";
			this.newMessage = new MessageInfo;
        ...
        public static const VIEWING_REGISTER_SCREEN:int = 1;        
        public static const VIEWING_INBOX_MAIL_SCREEN:int = 2;
        public static const VIEWING_MAIL_CREATION_SCREEN:int = 3;
        ...
        /** The new message for creation **/
        public var newMessage:MessageInfo;
...
//        public var messages:ArrayCollection;
        ...
        * We use them to autofill To, Cc and Bcc email input fields **/
        ...
        public var serversMessageCount:Number;		
