...
namespace Weborb.Samples.Email.Pop3
{
    ...
    public class Pop3MimeClient : Pop3MailClient
    {
        ...
        public RxMailMessage GetEmailHeader(int messsageNumber) {
            
            //request email header, send TOP command to POP3 server
            SendTopCommand(messsageNumber);
        ...
        /// </summary>
        private void ProcessMimeHeaderEntity(RxMailMessage message) {
        ...
        private MimeEntityReturnCode ProcessMimeEntity(RxMailMessage message, string parentBoundaryStart) {
            ...
            while (readMultiLine(out response)) {
                ...
                if (isBoundaryDefined && response.TrimEnd() == BoundaryDelimiterLineStart) {
                    ...
                    return
                        ProcessDelimitedBody(message, BoundaryDelimiterLineStart, parentBoundaryStart, parentBoundaryEnd);
                }
        ...
        private void ProcessHeaderField(RxMailMessage message, string headerField) {
            ...
            if (separatorPosition < 1) {
                ...
                // add header line to headers - off
...
//                        }
        ...
        /// </summary>
        public static string DecodeByteArryToString(byte[] ByteArry, Encoding ByteEncoding) {
            if (ByteArry == null) {
                //no bytes to convert
                return null;
            }
