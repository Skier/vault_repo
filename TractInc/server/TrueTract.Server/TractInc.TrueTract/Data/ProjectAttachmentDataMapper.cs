...
namespace TractInc.TrueTract.Data
{
    internal class ProjectAttachmentDataMapper
    {
        ...
        private const string SQL_UPDATE = @"
            UPDATE [TT_ProjectAttachment] set 
                ProjectAttachmentTypeId = @ProjectAttachmentTypeId, 
                ProjectId = @ProjectId,
                FileId = @FileId
            WHERE ProjectAttachmentId = @ProjectAttachmentId";
        
        private const string SQL_DELETE = @"
            DELETE [TT_ProjectAttachment] WHERE ProjectAttachmentId = @ProjectAttachmentId
        ";
        ...
        public void Update(SqlTransaction tran, ProjectAttachmentInfo attach)
        {
            List<SqlParameter> paramList = new List<SqlParameter>();
