...
namespace TractInc.Server.Data
{
    ...
    public static class Database
    {
        ...
        public static void Begin(DbConnectionEnum connectionKey)
        {
        ...
        public static IDbCommand PrepareCommand(String sql, DbConnectionEnum connectionKey)
        {
        ...
        {
            return PrepareCommand(sql, DbConnectionEnum.TractIncDb);
        }
