package truetract.plotter
{
    ...
    public class Plotter_code extends VBox
    {
        ...
        [Bindable] public var showCallAnnotations:Boolean = true;
        [Bindable] public var showTractArea:Boolean = true;
        ...
        public function AddCall( call:TractCall ):void 
        {
            ...
            if (Model.CallsList.length >= 1 && !showTractCallsPanel) {
 ...
 */            }
		...
		protected function sortByCallOrder(obj1:Object, obj2:Object):int 
		{
			var call1:TractCall = obj1 as TractCall;
			var call2:TractCall = obj2 as TractCall;
		
			if (call1.CallOrder < call2.CallOrder) {
				return -1;
			} else if (call1.CallOrder > call2.CallOrder) {
				return 1;
			} else {
				return 0;
			}
...
//            optimalGridWidth += 10; //TODO: something is missing. Need to figure out what is it.
        ...
        private function setCallDetailVisible(call:TractCall):void 
        {
        	var index:int = Model.CallsList.getItemIndex(call);
...
// ---- UI COMPONENTS EVENT HANDLERS -----
        ...
        protected function tractCall_clickHandler(event:TractCallEvent):void 
        {
		    ...
		    var index:Number = Model.CallsList.getItemIndex(event.callView.Model);
		    tractCallsList.selectedIndex = index;
		    tractCallsList.scrollToIndex(index);
        ...
        protected function tractPoint_mouseDownHandler(event:TractPointEvent):void 
        {
            switch (event.pointType) 
            {
                case TractPointEvent.TRACT_START_POINT :
                    ...
                    if (editMode && Model.CallsList.length == 0)
                    {
