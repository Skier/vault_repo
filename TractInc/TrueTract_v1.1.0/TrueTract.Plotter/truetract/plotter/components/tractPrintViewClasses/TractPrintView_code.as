package truetract.plotter.components.tractPrintViewClasses
{
...
import truetract.plotter.components.ScaleInput;
 ...
 */    
    ...
    public function exportTractToPdf():void
    {
		...
		var pageWidth:Number = (pageOrientation.selectedLabel == "Portrait") ? pageSize.selectedItem.width : pageSize.selectedItem.height;
		var pageHeight:Number = (pageOrientation.selectedLabel == "Portrait") ? pageSize.selectedItem.height : pageSize.selectedItem.width;

        var printTractWidth:Number = pageWidth - 72;
        var printTractHeight:Number = (pageHeight * (2/3)) - 72;
        ...
        var event:TractExportEvent = new TractExportEvent(tract, 
            getTractBitmapData(), getScaleBarBitmapData(), pageWidth/72, pageHeight/72);
