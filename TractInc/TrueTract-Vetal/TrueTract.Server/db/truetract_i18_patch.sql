...
CREATE TABLE ProjectAttachment (
    ...
    constraint FK_Project_ProjectAttachmentType foreign key(ProjectAttachmentTypeId) 
        references [ProjectAttachmentType](ProjectAttachmentTypeId),
    constraint FK_Project_File foreign key(FileId) 
...
ALTER TABLE [DocumentAttachment] ADD 
    FileId int NULL constraint FK_DocumentAttachment foreign key(FileId) references [File] (FileId)
GO
