namespace TractInc.TrueTract.Entity
{
    public class UserInfo
    {
        ...
        public UserInfo(string login, string firstName, string lastName, string phoneNumber, string password,
                        string email, bool isActive, int hackingAttempts, string defaultSite) {
            Login = login;
            FirstName = firstName;
            LastName = lastName;
        ...
        public UserInfo(int userId, string login, string firstName, string lastName, string phoneNumber, 
                        string password, string email, bool isActive, int hackingAttempts, string defaultSite)
            : this(login, firstName, lastName, phoneNumber, password, email, isActive, hackingAttempts, defaultSite) {
