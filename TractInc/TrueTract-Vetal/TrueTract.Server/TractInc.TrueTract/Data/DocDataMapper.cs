...
//        private const string DOCUMENT_IS_NOT_UNIQUE = "Document with such unique fields (State, County, DocType, DocNu, Volume, Page) is already exists";
            ...
            INSERT INTO [Document] (
                ...
                DocBranchUid
                 ...
                 VALUES ( @IsPublic, @DocTypeId, @Volume, @Page, @DocumentNo, @County, @State, 
                    @ResearchNote, @ImageLink, @CreatedBy, @Filed, @Signed, @Created, @IsActive, @DocBranchUid)
        ...
        private DocAttachmentDataMapper m_attachmentsDM;
        ...
        public List<DocumentInfo> GetAll(SqlTransaction tran, DocumentsFilterInfo filter) {
        ...
        private List<DocumentInfo> Select(SqlTransaction tran, string sql, List<SqlParameter> paramList) {
            ...
            foreach (DocumentInfo info in result)
            {
                ...
                info.Attachments = AttachmentsDM.GetAttachmentsByDocId(tran, info.DocID).ToArray();
            }
...
//            }
        ...
        private DocAttachmentDataMapper AttachmentsDM {
            get {
                if (null == m_attachmentsDM) {
                    m_attachmentsDM = new DocAttachmentDataMapper();
                }

                return m_attachmentsDM;
            }
        }
