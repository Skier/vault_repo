...
public class TractCall
{
    ...
    public function clone():TractCall
    {
        var clone:TractCall = new TractCall();

        clone.TractCallId = TractCallId;
        clone.TractId = TractId;
        clone.CallType = CallType;
        clone.CallOrder = CallOrder;
        clone.CreatedByMouse = CreatedByMouse;
