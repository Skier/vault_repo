...
// -----------
    ...
    public function addReference(reference:DocumentReference):void
    {
        ...
        var docToken:AsyncToken = saveDocument(document, AppModel.getInstance().user.UserId);
    ...
    {
        var asyncToken:AsyncToken = service.SaveReference(ref, AppModel.getInstance().user.UserId);
        asyncToken.addResponder(new TokenResponder(
            function (event:ResultEvent):void
            {
            	var reference:DocumentReference = DocumentReference(event.result);
    ...
    public function actualizeDocumentReference(reference:DocumentReference):void 
    {
	    ...
	    saveDocument(document, AppModel.getInstance().user.UserId).addResponder( new Responder(
	    	function (e:ResultEvent):void 
	    	{
