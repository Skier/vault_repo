...
/*                          
                            Alert.show("AddDocumentWizardController.fillDocReqFields: docType=" 
                                + view.docum.DocumentType.toXMLString());
*/                              
                            var isLease:Boolean = ("true" == view.docum.DocumentType.@IsLease);
                            if ( isLease ) {
                                view.fillDocLeaseFieldsStep.setDefaults(view.docum);
                                setStep(view.fillDocLeaseFieldsStep);
                            } else {
                    ...
                    case view.fillDocLeaseFieldsStep:
                        view.docLease = view.fillDocLeaseFieldsStep.docLease;
                        view.docum.Lease = view.docLease;
//                        Alert.show("Wizard.fillDocLeaseFieldStep: lcn=" + view.docLease.LCN);
