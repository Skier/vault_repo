...
public class DictionaryRegistry
{
	...
	[Embed(source="/data/ProjectTabContactTypes.xml",mimeType="application/octet-stream")] 
	private static const projectTabContactTypesFile:Class;

	[Embed(source="/data/WellPlanProjectAttachmentTypes.xml",mimeType="application/octet-stream")] 
	private static const wellPlanProjectAttachmentTypesFile:Class;
    ...
    [Bindable] public var projectTabContactTypes:XML;
    [Bindable] public var wellPlanProjectAttachmentTypes:XML;
    ...
    public function getProjectTabContactType(value:String):XMLList
    {
        return projectTabContactTypes.ProjectTabContactType.(@Value == value);
    }
    ...
    private function loadXMLs():void
    {
	    ...
	    ba = new projectTabContactTypesFile() as ByteArray;
    	projectTabContactTypes = new XML(ba.readUTFBytes(ba.length));

	    ba = new wellPlanProjectAttachmentTypesFile() as ByteArray;
    	wellPlanProjectAttachmentTypes = new XML(ba.readUTFBytes(ba.length));
