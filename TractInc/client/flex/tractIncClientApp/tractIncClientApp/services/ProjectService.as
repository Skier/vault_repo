...
public class ProjectService
{
    ...
    public function loadFullProject(project:Project):AsyncToken
    {
        ...
        asyncToken.addResponder(new TokenResponder(
            function (event:ResultEvent):void
            {
                project.setFieldsValues(event.result as Project);
    ...
    public function getAllProjects(clientId:int):ArrayCollection
    {
        var projects:ArrayCollection = new ArrayCollection();
        
        var asyncToken:AsyncToken = service.GetAllProjectsByClient(clientId);
        asyncToken.addResponder(new TokenResponder(
            function (event:ResultEvent):void
            {
    ...
    public function getDocReferencedProjects(documentId:int, clientId:int):ArrayCollection
    {
        var projects:ArrayCollection = new ArrayCollection();
        
        var asyncToken:AsyncToken = service.GetProjectsByDocumentAndClient(documentId, clientId);
        asyncToken.addResponder(new TokenResponder(
            function (event:ResultEvent):void
            {
                var result:Array = event.result as Array;
