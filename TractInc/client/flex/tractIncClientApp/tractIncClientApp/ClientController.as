...
import tractIncClientApp.ClientModel;
...
import tractIncClientApp.services.TrueTractService;
import truetract.domain.User;
import tractIncClientApp.ClientController;

public class ClientController
{
    public static var instance:ClientController;
    ...
    public function init(u:User):void
    {
        ...
        model.projects = projectService.getAllProjects(this.user.ClientId);
...
//      model.currentProject = null;
    ...
    public function searchByClient(searchString:String):void 
    {
        ...
        model.searchResult = ttService.searchByClient(searchString, this.user.ClientId);
