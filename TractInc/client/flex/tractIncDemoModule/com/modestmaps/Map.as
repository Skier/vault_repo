...
//          trace(new Error().getStackTrace());
        ...
        */
        ...
        public override function getBounds(tcs:DisplayObject):Rectangle 
        {
            Alert.show("getBounds: called.");
        	var rec:Rectangle = new Rectangle(-1, -1, this.width, this.height);
/*        	
            for each (var o:Object in children) {
            	Alert.show("o=" + o);
            	if ( null != (o as Polygon) ) {
            		return (o as Polygon).getComponentBounds();
            	}
            }
*/            
			return rec;
        ...
        public override function getRect(tcs:DisplayObject):Rectangle 
        {
            Alert.show("getRect: called.");
        	var rec:Rectangle = new Rectangle(-1, -1, this.width, this.height);
/*        	
            for each (var o:Object in children) {
            	Alert.show("o=" + o);
