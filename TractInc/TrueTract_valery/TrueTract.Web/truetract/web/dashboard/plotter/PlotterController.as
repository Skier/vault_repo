...
//                  view.plotter.initTract(tract.clone());
            ...
            DocumentService.getInstance().loadTract(tract.TractId).addResponder(loadTractResponder);
        } 
        else 
        {
//          TODO: method tract.clone() implemented but not tested yet
//          view.plotter.initTract(tract.clone());
    ...
    private function saveTract(tract:Tract):AsyncToken
    {
		...
		{
	        asyncToken = DocumentService.getInstance().saveTract(
	            tract, appModel.user.UserId);
