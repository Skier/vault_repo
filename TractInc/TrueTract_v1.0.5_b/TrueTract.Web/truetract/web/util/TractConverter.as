package truetract.web.util
{
	...
	public class TractConverter extends EventDispatcher
	{
        ...
        public function convertToPdf(tract:Tract, tractImage:ByteArray, scaleBarImage:ByteArray, user:User, pageWidth:Number, pageHeight:Number):void
        {
            service.ConvertToPdf(tract.ToTractWO(), tractImage, scaleBarImage, user, pageWidth, pageHeight);
        }
