...
//        	startPage.appController = this;
            ...
            asyncToken.addResponder ( new Responder(
                function (event:ResultEvent):void {
                    ...
                    if (serverTract.DocId) {
                        ...
                        if (serverTract.ParentDocument.Attachment) {
                        	tract.ParentDocument.Attachment = serverTract.ParentDocument.Attachment;
                        }
                    }
        ...
        public function plotter_pdfExportRequestHandler(event:TractExportEvent):void
        {
            ...
            converter.convertToPdf(event.tract, tractPng, scaleBarPng, model.user, pageWidth, pageHeight);
        }
