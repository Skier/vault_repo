package src.deedplotter.tools
{
    ...
    import src.deedplotter.components.tractViewClasses.call.propertyViews.CallTypeSelector;
    ...
    public class TractTool extends AbstractTool
    {
        ...
        override public function onPlotterMouseDown(event:MouseEvent):void 
        {
            ...
            call.Params.addItem(new DistanceParam(line.distance, UOMUtil.Instance().DefaultUOM));
