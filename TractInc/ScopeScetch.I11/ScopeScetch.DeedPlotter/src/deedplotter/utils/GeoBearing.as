package src.deedplotter.utils
{
    ...
    public class GeoBearing
    {
        ...
        private var m_HDirection:String; // Possible values : "E" and "W"
        private var m_VDirection:String; //Possible values : "N" and "S"

        private var m_nf:NumberFormatter;

        public function GeoBearing(hDir:String = "E", vDir:String = "N", dd:int = 0, mm:int = 0, ss:Number = 0) {
            HDirection = hDir;
            VDirection = vDir;
            Degree = dd;
            Minutes = mm;
