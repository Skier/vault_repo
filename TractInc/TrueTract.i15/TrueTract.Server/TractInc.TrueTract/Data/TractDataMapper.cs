...
namespace TractInc.TrueTract.Data
{
    internal class TractDataMapper
    {
        ...
        private const string SQL_SELECT_BY_REF_NAME = SQL_SELECT + " WHERE RefName like @RefName";
        ...
        public List<TractInfo> GetDrawingsByUser(SqlTransaction tran, int createdBy, bool getRelevant)
        {
        ...
        public List<TractInfo> GetTractsByRefName(SqlTransaction tran, string refName, bool getRelevant)
        {
            List<SqlParameter> paramList = new List<SqlParameter>();

            paramList.Add( new SqlParameter("RefName", refName));

            return Select(tran, SQL_SELECT_BY_REF_NAME, paramList, getRelevant);
        }

        public List<TractInfo> GetRecentDrawings(SqlTransaction tran, int userId, bool getRelevant) 
        {
            List<SqlParameter> paramList = new List<SqlParameter>();
