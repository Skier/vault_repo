package truetract.plotter.domain.settings
{
    ...
    public class UserSettingsRegistry
    {
        ...
        public function UserSettingsRegistry( caller : Function = null ) 
        {
            ...
            registerClassAlias("truetract.plotter.domain.settings.FontCssStyle", FontCssStyle);
            registerClassAlias("truetract.plotter.domain.settings.TractPointCssStyle", TractPointCssStyle);
            
            settingsSO = SharedObject.getLocal(TRUE_TRACT_PLOTTER_SETTINGS_SO_NAME);
        ...
        private const TRUE_TRACT_PLOTTER_SETTINGS_SO_NAME:String = "true_tract_plotter_settings";
