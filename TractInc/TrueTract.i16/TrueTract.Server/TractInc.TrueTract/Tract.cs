    ...
    internal class Tract
    {
        ...
        public List<TractInfo> GetUserDrawings(int userId) {
            ...
            using (SqlConnection conn = SQLHelper.CreateConnection()) 
            {
                ...
                result = TractDM.GetUserDrawings(tran, userId, false);
        ...
        public List<TractInfo> GetUserRecentDrawings(int userId) {
            ...
            using (SqlConnection conn = SQLHelper.CreateConnection()) 
            {
                ...
                result = TractDM.GetUserRecentDrawings(tran, userId, false);
        ...
        public List<TractInfo> GetUserDrawingsByRefName(int userId, string refName) {
            List<TractInfo> result;
            ...
            using (SqlConnection conn = SQLHelper.CreateConnection()) 
            {
                ...
                result = TractDM.GetUserDrawingsByRefName(tran, userId, refName, false);
