      ...
      [Bindable]
      public dynamic class _Countys extends ActiveRecord
      {
      private var _uri:String = null;
        ...
        protected var _cNTY_FIPS: String;
        ...
        protected var _icoMapAttr: String;
      
        // parent tables
        internal var _parentStates: States
            = new States()
        ;
            ...
            public function get  CNTY_FIPS(): String
            {
            return _cNTY_FIPS;
            }

            public function set  CNTY_FIPS(value:String):void
            {
            ...
            public function get  IcoMapAttr(): String
            {
            return _icoMapAttr;
            }

            public function set  IcoMapAttr(value:String):void
            {
            
            _icoMapAttr = value;
            }
          
        public function get ParentStates():States
        {
        if(IsLoaded  && 
        
        !(_parentStates.IsLoaded || _parentStates.IsLoading))
        {
          _parentStates = DataMapperRegistry.Instance.States.load(_parentStates);
          
          onParentChanged(_parentStates);
        }

        return _parentStates;
        }
        public function set ParentStates(value:States):void
        {
          _parentStates = States(IdentityMap.register( value ));
        ...
        protected override function onDirtyChanged():void
        {
            ...
            if(ParentStates != null)
              ParentStates.onChildChanged(this);
        ...
        {
          var object:Countys = new Countys();
            ...
            object.CNTY_FIPS = this.CNTY_FIPS;
            ...
            object.IcoMapAttr = this.IcoMapAttr;
        ...
        {
          return DataMapperRegistry.Instance.Countys;
        }
