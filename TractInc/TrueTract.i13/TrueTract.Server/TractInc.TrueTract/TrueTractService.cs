...
namespace TractInc.TrueTract
{
    public class TrueTractService
    {
        ...
        private Attachment m_attachmentBC;
        ...
        public TractInfo SaveTract(TractInfo tract, int userId)
        {
            using (SqlConnection conn = SQLHelper.CreateConnection())
            {
                ...
                if (null != tract.ParentDocument)
                {
                    ...
                    if (tract.ParentDocument.Attachment != null)
                    {
                        tract.ParentDocument.Attachment = AttachmentBC.Update(tran, tract.ParentDocument.Attachment);
                    }
                }
        ...
        private Attachment AttachmentBC
        {
            get
            {
                if (null == m_attachmentBC)
                {
                    m_attachmentBC = new Attachment();
                }

                return m_attachmentBC;
            }
        }
