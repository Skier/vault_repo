...
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(4, 4, 'Meals',          0, 0, 1, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(5, 5, 'Phone',          0, 0, 1, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(6, 6, 'Copies',         0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(7, 7, 'Filing Fees',    0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(8, 8, 'Travel',         0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(9, 9, 'Postage',        0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(10, 10, 'Fax',          0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(11, 11, 'Abstractor',   0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(12, 12, 'Notary',       0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(13, 13, 'Photo',        0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(14, 14, 'Other',        0, 0, 0, 0, 0);
insert into BillItemType (BillItemTypeId, InvoiceItemTypeId, [Name], IsCountable, IsPresetRate, IsSingle, IsAttachRequired, Deleted) values(15, 15, 'Other Fees',   0, 0, 0, 0, 0);
