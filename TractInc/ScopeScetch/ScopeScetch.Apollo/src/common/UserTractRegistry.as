package src.common
{
	...
	public class UserTractRegistry
	{
		...
		public function GetTract(uid:String):Tract {
			...
			var t:Object = so.data.tract;
			var tract:Tract = new Tract();
			tract.Uid = t.Uid;
			tract.TractId = t.TractId;
			tract.Easting = t.Easting;
			tract.Northing = t.Northing;
			tract.Description = t.Description;
			tract.CreatedBy = t.CreatedBy;
			tract.IsDeleted = t.IsDeleted;
			
			tract.Calls = t.Calls;
			tract.TextObjects = t.TextObjects;
		...
		public function SaveTract(tract:Tract, addToList:Boolean):void {
			...
			if ( !Exists(tract, NewTracts) && !Exists(tract, ChangedTracts) && addToList ) {
		...
		public function Exists(tract:Tract, tractList:ArrayCollection):Boolean {
			for each (var string:String in tractList) {
				if ( string == tract.Uid ) {
					return true;
				}
			}
