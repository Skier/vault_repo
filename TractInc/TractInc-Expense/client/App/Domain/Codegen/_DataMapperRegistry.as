     ...
     package App.Domain.Codegen
     {
        ...
        import App.Domain.BillItemCompositionDataMapper;
      
        import App.Domain.SubAfeDataMapper;
      
        import App.Domain.DefaultBillRateDataMapper;
      
        import App.Domain.DefaultInvoiceRateDataMapper;
        ...
        import App.Domain.WorkLogDataMapper;
       ...
       public class _DataMapperRegistry
       {
          ...
          private var m_billItemCompositionDataMapper:BillItemCompositionDataMapper;

          public function get BillItemComposition():BillItemCompositionDataMapper
          {
            if(m_billItemCompositionDataMapper == null )
              m_billItemCompositionDataMapper = new BillItemCompositionDataMapper();
              
            return m_billItemCompositionDataMapper;
          }
          ...
          private var m_defaultBillRateDataMapper:DefaultBillRateDataMapper;

          public function get DefaultBillRate():DefaultBillRateDataMapper
          {
            if(m_defaultBillRateDataMapper == null )
              m_defaultBillRateDataMapper = new DefaultBillRateDataMapper();
              
            return m_defaultBillRateDataMapper;
          }
        

          private var m_defaultInvoiceRateDataMapper:DefaultInvoiceRateDataMapper;

          public function get DefaultInvoiceRate():DefaultInvoiceRateDataMapper
          {
            if(m_defaultInvoiceRateDataMapper == null )
              m_defaultInvoiceRateDataMapper = new DefaultInvoiceRateDataMapper();
              
            return m_defaultInvoiceRateDataMapper;
          }
          ...
          private var m_workLogDataMapper:WorkLogDataMapper;

          public function get WorkLog():WorkLogDataMapper
          {
            if(m_workLogDataMapper == null )
              m_workLogDataMapper = new WorkLogDataMapper();
              
            return m_workLogDataMapper;
          }
