      ...
      package App.Domain
      {
        public final class ActiveRecords
        {
            ...
            public static function get BillItemComposition():BillItemCompositionDataMapper
            {
            ...
            public static function get DefaultBillRate():DefaultBillRateDataMapper
            {
              return DataMapperRegistry.Instance.DefaultBillRate;
            }
          

            public static function get DefaultInvoiceRate():DefaultInvoiceRateDataMapper
            {
            ...
            public static function get WorkLog():WorkLogDataMapper
            {
