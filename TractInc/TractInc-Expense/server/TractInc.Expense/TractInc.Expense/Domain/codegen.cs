    ...
    public partial class TractIncRAIDDb:TDatabase<SqlConnection,SqlTransaction,SqlCommand>
    {
      public TractIncRAIDDb()
      {
        ...
        public BillItemComposition create(BillItemComposition billItemComposition)
        {
          BillItemCompositionDataMapper dataMapper = new BillItemCompositionDataMapper(this);
          
          return dataMapper.create(billItemComposition);
        }

        public BillItemComposition update(BillItemComposition billItemComposition)
        {
          BillItemCompositionDataMapper dataMapper = new BillItemCompositionDataMapper(this);

          return dataMapper.update(billItemComposition);
        }

        public BillItemComposition remove(BillItemComposition billItemComposition)
        {
          BillItemCompositionDataMapper dataMapper = new BillItemCompositionDataMapper(this);

          return dataMapper.remove(billItemComposition);
        }
        ...
        public DefaultBillRate create(DefaultBillRate defaultBillRate)
        {
          DefaultBillRateDataMapper dataMapper = new DefaultBillRateDataMapper(this);
          
          return dataMapper.create(defaultBillRate);
        }

        public DefaultBillRate update(DefaultBillRate defaultBillRate)
        {
          DefaultBillRateDataMapper dataMapper = new DefaultBillRateDataMapper(this);

          return dataMapper.update(defaultBillRate);
        }

        public DefaultBillRate remove(DefaultBillRate defaultBillRate)
        {
          DefaultBillRateDataMapper dataMapper = new DefaultBillRateDataMapper(this);

          return dataMapper.remove(defaultBillRate);
        }
      

        public DefaultInvoiceRate create(DefaultInvoiceRate defaultInvoiceRate)
        {
          DefaultInvoiceRateDataMapper dataMapper = new DefaultInvoiceRateDataMapper(this);
          
          return dataMapper.create(defaultInvoiceRate);
        }

        public DefaultInvoiceRate update(DefaultInvoiceRate defaultInvoiceRate)
        {
          DefaultInvoiceRateDataMapper dataMapper = new DefaultInvoiceRateDataMapper(this);

          return dataMapper.update(defaultInvoiceRate);
        }

        public DefaultInvoiceRate remove(DefaultInvoiceRate defaultInvoiceRate)
        {
          DefaultInvoiceRateDataMapper dataMapper = new DefaultInvoiceRateDataMapper(this);

          return dataMapper.remove(defaultInvoiceRate);
        }
        ...
        {
          WorkLogDataMapper dataMapper = new WorkLogDataMapper(this);
          
          return dataMapper.create(workLog);
        }
        ...
        public WorkLog update(WorkLog workLog)
        {
          ...
          return dataMapper.update(workLog);
        }

        public WorkLog remove(WorkLog workLog)
        {
          WorkLogDataMapper dataMapper = new WorkLogDataMapper(this);

          return dataMapper.remove(workLog);
        }
  ...
  [TransactionRequired]
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      return client;
          ...
          // one to many relation
          private List<DefaultInvoiceRate> _relatedDefaultInvoiceRate;

          public List<DefaultInvoiceRate> relatedDefaultInvoiceRate
          {
          get { return _relatedDefaultInvoiceRate;}
          set { _relatedDefaultInvoiceRate = value; }
          }
          
          
          public DefaultInvoiceRate addRelatedDefaultInvoiceRateItem(
          DefaultInvoiceRate defaultInvoiceRate)
          {
            defaultInvoiceRate.RelatedClient = this;
            
            _relatedDefaultInvoiceRate.Add(defaultInvoiceRate);
    ...
    public override Client create( Client client )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
          ...
          if(client.relatedDefaultInvoiceRate != null 
            && client.relatedDefaultInvoiceRate.Count > 0)
          {
            DefaultInvoiceRateDataMapper dataMapper = new DefaultInvoiceRateDataMapper(Database);
            
            foreach(DefaultInvoiceRate item in client.relatedDefaultInvoiceRate)
              dataMapper.create(item);
          }
  ...
  [TransactionRequired]
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      return asset;
          ...
          // one to many relation
          private List<DefaultBillRate> _relatedDefaultBillRate;

          public List<DefaultBillRate> relatedDefaultBillRate
          {
          get { return _relatedDefaultBillRate;}
          set { _relatedDefaultBillRate = value; }
          }
          
          
          public DefaultBillRate addRelatedDefaultBillRateItem(
          DefaultBillRate defaultBillRate)
          {
            defaultBillRate.RelatedAsset = this;
            
            _relatedDefaultBillRate.Add(defaultBillRate);
    ...
    public override Asset create( Asset asset )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
          ...
          if(asset.relatedDefaultBillRate != null 
            && asset.relatedDefaultBillRate.Count > 0)
          {
            DefaultBillRateDataMapper dataMapper = new DefaultBillRateDataMapper(Database);
            
            foreach(DefaultBillRate item in asset.relatedDefaultBillRate)
              dataMapper.create(item);
          }
  ...
  [TransactionRequired]
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      return invoiceItemType;
          ...
          DefaultInvoiceRate defaultInvoiceRate)
          {
            defaultInvoiceRate.RelatedInvoiceItemType = this;
    ...
    public override InvoiceItemType create( InvoiceItemType invoiceItemType )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
          ...
          if(invoiceItemType.relatedDefaultInvoiceRate != null 
            && invoiceItemType.relatedDefaultInvoiceRate.Count > 0)
          {
            DefaultInvoiceRateDataMapper dataMapper = new DefaultInvoiceRateDataMapper(Database);
            
            foreach(DefaultInvoiceRate item in invoiceItemType.relatedDefaultInvoiceRate)
              dataMapper.create(item);
          }
  ...
  [TransactionRequired]
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      return bill;
          ...
          // one to many relation
          private List<BillItemComposition> _relatedBillItemComposition;

          public List<BillItemComposition> relatedBillItemComposition
          {
          get { return _relatedBillItemComposition;}
          set { _relatedBillItemComposition = value; }
          }
          
          
          public BillItemComposition addRelatedBillItemCompositionItem(
          BillItemComposition billItemComposition)
          {
            billItemComposition.RelatedBill = this;
            
            _relatedBillItemComposition.Add(billItemComposition);
    ...
    public override Bill create( Bill bill )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
          ...
          if(bill.relatedBillItemComposition != null 
            && bill.relatedBillItemComposition.Count > 0)
          {
            BillItemCompositionDataMapper dataMapper = new BillItemCompositionDataMapper(Database);
            
            foreach(BillItemComposition item in bill.relatedBillItemComposition)
              dataMapper.create(item);
          }
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      return billItemType;
          ...
          BillItemComposition billItemComposition)
          {
            billItemComposition.RelatedBillItemType = this;
          ...
          DefaultBillRate defaultBillRate)
          {
            defaultBillRate.RelatedBillItemType = this;
    ...
    public override BillItemType create( BillItemType billItemType )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
          ...
          if(billItemType.relatedBillItemComposition != null 
            && billItemType.relatedBillItemComposition.Count > 0)
          {
            BillItemCompositionDataMapper dataMapper = new BillItemCompositionDataMapper(Database);
            
            foreach(BillItemComposition item in billItemType.relatedBillItemComposition)
              dataMapper.create(item);
          }
        
          
          if(billItemType.relatedDefaultBillRate != null 
            && billItemType.relatedDefaultBillRate.Count > 0)
          {
            DefaultBillRateDataMapper dataMapper = new DefaultBillRateDataMapper(Database);
            
            foreach(DefaultBillRate item in billItemType.relatedDefaultBillRate)
              dataMapper.create(item);
          }
  ...
  [TransactionRequired]
    ...
    public partial class BillItemComposition: DomainObject
    {
    
      protected int _billItemCompositionId;
    ...
    public BillItemComposition(){}

    public BillItemComposition(
    int 
            billItemCompositionId,int 
            billId,int 
    ...
    )
    {
      ...
      this.BillItemCompositionId = billItemCompositionId;
    ...
    String uri = "TractIncRAID.BillItemComposition."
    ...
    return uri;
      ...
      public int BillItemCompositionId
      {
            ...
            get { return _billItemCompositionId;}
            set 
            { 
    ...
    public override DomainObject extractSingleObject()
    {
      BillItemComposition billItemComposition = new BillItemComposition();
      
      billItemComposition.BillItemCompositionId = this.BillItemCompositionId;
      billItemComposition.BillId = this.BillId;
      billItemComposition.BillItemTypeId = this.BillItemTypeId;
      billItemComposition.Amount = this.Amount;
      billItemComposition.Description = this.Description;
      billItemComposition.ActiveRecordId = this.ActiveRecordId; 
      return billItemComposition;
    }
          ...
          BillItem billItem)
          {
            billItem.RelatedBillItemComposition = this;
    ...
    public abstract class _BillItemCompositionDataMapper:TDataMapper<BillItemComposition,SqlConnection,TractIncRAIDDb, Weborb.Data.Management.MSSql.CommandBuilder, SqlTransaction, SqlCommand>
    {
      public _BillItemCompositionDataMapper(){}
      public _BillItemCompositionDataMapper(TractIncRAIDDb database):
      base(database){}
        public override String TableName
        {
          get
          {
            return "[dbo].[BillItemComposition]";
          }
        }
    ...
    private const String SqlCreate = @"Insert Into [dbo].[BillItemComposition] (
    ...
    [TransactionRequired]
    [Synchronized]
    public override BillItemComposition create( BillItemComposition billItemComposition )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
                  ...
                  sqlCommand.Parameters.AddWithValue("@billId", billItemComposition.BillId);
              
                  sqlCommand.Parameters.AddWithValue("@billItemTypeId", billItemComposition.BillItemTypeId);
              
                  sqlCommand.Parameters.AddWithValue("@amount", billItemComposition.Amount);
              
                  sqlCommand.Parameters.AddWithValue("@description", billItemComposition.Description);
              billItemComposition.BillItemCompositionId = int.Parse( sqlCommand.ExecuteScalar().ToString()) ;
          ...
          if(billItemComposition.relatedBillItem != null 
            && billItemComposition.relatedBillItem.Count > 0)
          {
            BillItemDataMapper dataMapper = new BillItemDataMapper(Database);
            
            foreach(BillItem item in billItemComposition.relatedBillItem)
              dataMapper.create(item);
          }
        
      
      raiseAffected(billItemComposition,DataMapperOperation.create);

      return registerRecord(billItemComposition);
    }
    ...
    public BillItemComposition findByPrimaryKey(
    int billItemCompositionId
    )
    {
    using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
    {
    using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
    {
          ...
          sqlCommand.Parameters.AddWithValue("@billItemCompositionId", billItemCompositionId);
      ...
      throw new DataNotFoundException("BillItemComposition not found, search by primary key");
 

    }


    public bool exists(BillItemComposition billItemComposition)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
          {
                ...
                sqlCommand.Parameters.AddWithValue("@BillItemCompositionId", billItemComposition.BillItemCompositionId);
    ...
    private const string CheckInSql = @"
      ...
      [BillItemComposition].[BillItemCompositionId] = @CheckInBillItemCompositionId";

    protected override IDbCommand PrepareCheckInCommand(DomainObject domainObject, string sqlQuery)
    {
      BillItemComposition _BillItemComposition = (BillItemComposition)domainObject;

       SqlCommand sqlCommand = Database.CreateCommand(ModifyQueryForCheckIn(sqlQuery,CheckInSql));

      
        sqlCommand.Parameters.AddWithValue("@CheckInBillItemCompositionId", _BillItemComposition.BillItemCompositionId);
    ...
    protected override BillItemComposition doLoad(IDataReader dataReader)
    {
    BillItemComposition billItemComposition = new BillItemComposition();

    billItemComposition.BillItemCompositionId = (int) dataReader.GetValue(0);
            billItemComposition.BillId = (int) dataReader.GetValue(1);
            billItemComposition.BillItemTypeId = (int) dataReader.GetValue(2);
            billItemComposition.Amount = (decimal) dataReader.GetValue(3);
            billItemComposition.Description = (String) dataReader.GetValue(4);
    ...
    protected override BillItemComposition doLoad(Hashtable hashtable)
    {
      BillItemComposition billItemComposition = new BillItemComposition();

      
        
        if(hashtable.ContainsKey("BillItemCompositionId"))
        billItemComposition.BillItemCompositionId = ( int)hashtable["BillItemCompositionId"];
          
        
        if(hashtable.ContainsKey("BillId"))
        billItemComposition.BillId = ( int)hashtable["BillId"];
          
        
        if(hashtable.ContainsKey("BillItemTypeId"))
        billItemComposition.BillItemTypeId = ( int)hashtable["BillItemTypeId"];
          
        
        if(hashtable.ContainsKey("Amount"))
        billItemComposition.Amount = ( decimal)hashtable["Amount"];
          
        
        if(hashtable.ContainsKey("Description"))
        billItemComposition.Description = ( String)hashtable["Description"];
    ...
    protected override List<BillItemComposition> fill(SqlCommand sqlCommand, int offset, int limit)
    {
        List<BillItemComposition> resultList = new List<BillItemComposition>();
         ...
         using(SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand))
         {
            ...
            foreach(DataRow dataRow in dataTable.Rows)
            {
              BillItemComposition item = new BillItemComposition();
              
              
                    item.BillItemCompositionId = ( int)dataRow["BillItemCompositionId"] ;
                  
                    item.BillId = ( int)dataRow["BillId"] ;
                  
                    item.BillItemTypeId = ( int)dataRow["BillItemTypeId"] ;
                  
                    item.Amount = ( decimal)dataRow["Amount"] ;
    ...
    #region Delete
    private const String SqlDelete = @"Delete From [dbo].[BillItemComposition]
    
      Where
      
        [BillItemCompositionId] = @billItemCompositionId";
    [Synchronized]
    public override BillItemComposition remove(BillItemComposition billItemComposition)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlDelete))
      ...
      raiseAffected(billItemComposition,DataMapperOperation.delete);
    ...
    [Synchronized]
    [TransactionRequired]
    public override BillItemComposition save( BillItemComposition billItemComposition )
    {
      if(exists(billItemComposition))
        return update(billItemComposition);
        return create(billItemComposition);
    }

  
      const String SqlUpdate = @"Update [dbo].[BillItemComposition] Set
    ...
    [TransactionRequired]
    [Synchronized]
    public override BillItemComposition update(BillItemComposition billItemComposition)
    {
        ...
        raiseAffected(billItemComposition,DataMapperOperation.update);
    ...
    public partial class DefaultBillRate: DomainObject
    {
    
      protected int _defaultBillRateId;
    ...
    public DefaultBillRate(){}

    public DefaultBillRate(
    int 
            defaultBillRateId,int 
            assetId,int 
            billItemTypeId,decimal 
            billRate
    )
    {
      ...
      this.DefaultBillRateId = defaultBillRateId;
    ...
    String uri = "TractIncRAID.DefaultBillRate."
    ...
    return uri;
      ...
      public int DefaultBillRateId
      {
        
            get { return _defaultBillRateId;}
            set 
            { 
    ...
    public override DomainObject extractSingleObject()
    {
      DefaultBillRate defaultBillRate = new DefaultBillRate();
      
      defaultBillRate.DefaultBillRateId = this.DefaultBillRateId;
      defaultBillRate.AssetId = this.AssetId;
      defaultBillRate.BillItemTypeId = this.BillItemTypeId;
      defaultBillRate.BillRate = this.BillRate;
      defaultBillRate.ActiveRecordId = this.ActiveRecordId; 
      return defaultBillRate;
    }
    ...
    public abstract class _DefaultBillRateDataMapper:TDataMapper<DefaultBillRate,SqlConnection,TractIncRAIDDb, Weborb.Data.Management.MSSql.CommandBuilder, SqlTransaction, SqlCommand>
    {
      public _DefaultBillRateDataMapper(){}
      public _DefaultBillRateDataMapper(TractIncRAIDDb database):
      base(database){}
        public override String TableName
        {
          get
          {
            return "[dbo].[DefaultBillRate]";
          }
        }
    ...
    private const String SqlCreate = @"Insert Into [dbo].[DefaultBillRate] (
    ...
    [Synchronized]
    public override DefaultBillRate create( DefaultBillRate defaultBillRate )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
                  ...
                  sqlCommand.Parameters.AddWithValue("@assetId", defaultBillRate.AssetId);
              
                  sqlCommand.Parameters.AddWithValue("@billItemTypeId", defaultBillRate.BillItemTypeId);
              
                  sqlCommand.Parameters.AddWithValue("@billRate", defaultBillRate.BillRate);
              defaultBillRate.DefaultBillRateId = int.Parse( sqlCommand.ExecuteScalar().ToString()) ;
      ...
      raiseAffected(defaultBillRate,DataMapperOperation.create);

      return registerRecord(defaultBillRate);
    }
    ...
    private const String SqlSelectByPk = @"Select
      ...
      [BillItemTypeId] ,
      [BillRate] 
     From [dbo].[DefaultBillRate]
    
       Where 
      
         [DefaultBillRateId] = @defaultBillRateId
    ";

    public DefaultBillRate findByPrimaryKey(
    int defaultBillRateId
    )
    {
    using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
    {
    using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
    {
          ...
          sqlCommand.Parameters.AddWithValue("@defaultBillRateId", defaultBillRateId);
      ...
      throw new DataNotFoundException("DefaultBillRate not found, search by primary key");
 

    }


    public bool exists(DefaultBillRate defaultBillRate)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
          {
                ...
                sqlCommand.Parameters.AddWithValue("@DefaultBillRateId", defaultBillRate.DefaultBillRateId);
    ...
    private const string CheckInSql = @"
      ...
      [DefaultBillRate].[DefaultBillRateId] = @CheckInDefaultBillRateId";

    protected override IDbCommand PrepareCheckInCommand(DomainObject domainObject, string sqlQuery)
    {
      DefaultBillRate _DefaultBillRate = (DefaultBillRate)domainObject;

       SqlCommand sqlCommand = Database.CreateCommand(ModifyQueryForCheckIn(sqlQuery,CheckInSql));

      
        sqlCommand.Parameters.AddWithValue("@CheckInDefaultBillRateId", _DefaultBillRate.DefaultBillRateId);
    ...
    protected override DefaultBillRate doLoad(IDataReader dataReader)
    {
    DefaultBillRate defaultBillRate = new DefaultBillRate();

    defaultBillRate.DefaultBillRateId = (int) dataReader.GetValue(0);
            defaultBillRate.AssetId = (int) dataReader.GetValue(1);
            defaultBillRate.BillItemTypeId = (int) dataReader.GetValue(2);
            defaultBillRate.BillRate = (decimal) dataReader.GetValue(3);
    ...
    protected override DefaultBillRate doLoad(Hashtable hashtable)
    {
      DefaultBillRate defaultBillRate = new DefaultBillRate();

      
        
        if(hashtable.ContainsKey("DefaultBillRateId"))
        defaultBillRate.DefaultBillRateId = ( int)hashtable["DefaultBillRateId"];
          
        
        if(hashtable.ContainsKey("AssetId"))
        defaultBillRate.AssetId = ( int)hashtable["AssetId"];
          
        
        if(hashtable.ContainsKey("BillItemTypeId"))
        defaultBillRate.BillItemTypeId = ( int)hashtable["BillItemTypeId"];
          
        
        if(hashtable.ContainsKey("BillRate"))
        defaultBillRate.BillRate = ( decimal)hashtable["BillRate"];
    ...
    protected override List<DefaultBillRate> fill(SqlCommand sqlCommand, int offset, int limit)
    {
        List<DefaultBillRate> resultList = new List<DefaultBillRate>();
         ...
         using(SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand))
         {
            ...
            foreach(DataRow dataRow in dataTable.Rows)
            {
              DefaultBillRate item = new DefaultBillRate();
              
              
                    item.DefaultBillRateId = ( int)dataRow["DefaultBillRateId"] ;
    ...
    #region Delete
    private const String SqlDelete = @"Delete From [dbo].[DefaultBillRate]
    
      Where
      
        [DefaultBillRateId] = @defaultBillRateId";
    [Synchronized]
    public override DefaultBillRate remove(DefaultBillRate defaultBillRate)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlDelete))
      ...
      raiseAffected(defaultBillRate,DataMapperOperation.delete);
    ...
    [Synchronized]
    [TransactionRequired]
    public override DefaultBillRate save( DefaultBillRate defaultBillRate )
    {
      if(exists(defaultBillRate))
        return update(defaultBillRate);
        return create(defaultBillRate);
    }

  
      const String SqlUpdate = @"Update [dbo].[DefaultBillRate] Set
    ...
    [Synchronized]
    public override DefaultBillRate update(DefaultBillRate defaultBillRate)
    {
        ...
        raiseAffected(defaultBillRate,DataMapperOperation.update);
    ...
    public partial class DefaultInvoiceRate: DomainObject
    {
    
      protected int _defaultInvoiceRateId;
    ...
    public DefaultInvoiceRate(){}

    public DefaultInvoiceRate(
    int 
            defaultInvoiceRateId,int 
            clientId,int 
    ...
    )
    {
      ...
      this.DefaultInvoiceRateId = defaultInvoiceRateId;
    ...
    String uri = "TractIncRAID.DefaultInvoiceRate."
    ...
    return uri;
      ...
      public int DefaultInvoiceRateId
      {
        
            get { return _defaultInvoiceRateId;}
            set 
            { 
    ...
    public override DomainObject extractSingleObject()
    {
      DefaultInvoiceRate defaultInvoiceRate = new DefaultInvoiceRate();
      
      defaultInvoiceRate.DefaultInvoiceRateId = this.DefaultInvoiceRateId;
      defaultInvoiceRate.ClientId = this.ClientId;
      defaultInvoiceRate.InvoiceItemTypeId = this.InvoiceItemTypeId;
      defaultInvoiceRate.InvoiceRate = this.InvoiceRate;
      defaultInvoiceRate.ActiveRecordId = this.ActiveRecordId; 
      return defaultInvoiceRate;
    }
    ...
    public abstract class _DefaultInvoiceRateDataMapper:TDataMapper<DefaultInvoiceRate,SqlConnection,TractIncRAIDDb, Weborb.Data.Management.MSSql.CommandBuilder, SqlTransaction, SqlCommand>
    {
      public _DefaultInvoiceRateDataMapper(){}
      public _DefaultInvoiceRateDataMapper(TractIncRAIDDb database):
      base(database){}
        public override String TableName
        {
          get
          {
            return "[dbo].[DefaultInvoiceRate]";
          }
        }
    ...
    private const String SqlCreate = @"Insert Into [dbo].[DefaultInvoiceRate] (
    ...
    [Synchronized]
    public override DefaultInvoiceRate create( DefaultInvoiceRate defaultInvoiceRate )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
                  ...
                  sqlCommand.Parameters.AddWithValue("@clientId", defaultInvoiceRate.ClientId);
              
                  sqlCommand.Parameters.AddWithValue("@invoiceItemTypeId", defaultInvoiceRate.InvoiceItemTypeId);
              
                  sqlCommand.Parameters.AddWithValue("@invoiceRate", defaultInvoiceRate.InvoiceRate);
              defaultInvoiceRate.DefaultInvoiceRateId = int.Parse( sqlCommand.ExecuteScalar().ToString()) ;
      ...
      raiseAffected(defaultInvoiceRate,DataMapperOperation.create);

      return registerRecord(defaultInvoiceRate);
    }
    ...
    private const String SqlSelectByPk = @"Select
      ...
      [DefaultInvoiceRateId] ,
      [ClientId] ,
      [InvoiceItemTypeId] ,
      [InvoiceRate] 
     From [dbo].[DefaultInvoiceRate]
    
       Where 
      
         [DefaultInvoiceRateId] = @defaultInvoiceRateId
    ";

    public DefaultInvoiceRate findByPrimaryKey(
    int defaultInvoiceRateId
    )
    {
    using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
    {
    using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
    {
          ...
          sqlCommand.Parameters.AddWithValue("@defaultInvoiceRateId", defaultInvoiceRateId);
      ...
      throw new DataNotFoundException("DefaultInvoiceRate not found, search by primary key");
 

    }


    public bool exists(DefaultInvoiceRate defaultInvoiceRate)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
          {
                ...
                sqlCommand.Parameters.AddWithValue("@DefaultInvoiceRateId", defaultInvoiceRate.DefaultInvoiceRateId);
    ...
    private const string CheckInSql = @"
      ...
      [DefaultInvoiceRate].[DefaultInvoiceRateId] = @CheckInDefaultInvoiceRateId";

    protected override IDbCommand PrepareCheckInCommand(DomainObject domainObject, string sqlQuery)
    {
      DefaultInvoiceRate _DefaultInvoiceRate = (DefaultInvoiceRate)domainObject;

       SqlCommand sqlCommand = Database.CreateCommand(ModifyQueryForCheckIn(sqlQuery,CheckInSql));

      
        sqlCommand.Parameters.AddWithValue("@CheckInDefaultInvoiceRateId", _DefaultInvoiceRate.DefaultInvoiceRateId);
    ...
    protected override DefaultInvoiceRate doLoad(IDataReader dataReader)
    {
    DefaultInvoiceRate defaultInvoiceRate = new DefaultInvoiceRate();

    defaultInvoiceRate.DefaultInvoiceRateId = (int) dataReader.GetValue(0);
            defaultInvoiceRate.ClientId = (int) dataReader.GetValue(1);
            defaultInvoiceRate.InvoiceItemTypeId = (int) dataReader.GetValue(2);
            defaultInvoiceRate.InvoiceRate = (decimal) dataReader.GetValue(3);
    ...
    protected override DefaultInvoiceRate doLoad(Hashtable hashtable)
    {
      DefaultInvoiceRate defaultInvoiceRate = new DefaultInvoiceRate();

      
        
        if(hashtable.ContainsKey("DefaultInvoiceRateId"))
        defaultInvoiceRate.DefaultInvoiceRateId = ( int)hashtable["DefaultInvoiceRateId"];
          
        
        if(hashtable.ContainsKey("ClientId"))
        defaultInvoiceRate.ClientId = ( int)hashtable["ClientId"];
          
        
        if(hashtable.ContainsKey("InvoiceItemTypeId"))
        defaultInvoiceRate.InvoiceItemTypeId = ( int)hashtable["InvoiceItemTypeId"];
          
        
        if(hashtable.ContainsKey("InvoiceRate"))
        defaultInvoiceRate.InvoiceRate = ( decimal)hashtable["InvoiceRate"];
    ...
    protected override List<DefaultInvoiceRate> fill(SqlCommand sqlCommand, int offset, int limit)
    {
        List<DefaultInvoiceRate> resultList = new List<DefaultInvoiceRate>();
         ...
         using(SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand))
         {
            ...
            foreach(DataRow dataRow in dataTable.Rows)
            {
              DefaultInvoiceRate item = new DefaultInvoiceRate();
              
              
                    item.DefaultInvoiceRateId = ( int)dataRow["DefaultInvoiceRateId"] ;
    ...
    #region Delete
    private const String SqlDelete = @"Delete From [dbo].[DefaultInvoiceRate]
    
      Where
      
        [DefaultInvoiceRateId] = @defaultInvoiceRateId";
    [Synchronized]
    public override DefaultInvoiceRate remove(DefaultInvoiceRate defaultInvoiceRate)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlDelete))
      ...
      raiseAffected(defaultInvoiceRate,DataMapperOperation.delete);
    ...
    [Synchronized]
    [TransactionRequired]
    public override DefaultInvoiceRate save( DefaultInvoiceRate defaultInvoiceRate )
    {
      if(exists(defaultInvoiceRate))
        return update(defaultInvoiceRate);
        return create(defaultInvoiceRate);
    }

  
      const String SqlUpdate = @"Update [dbo].[DefaultInvoiceRate] Set
    ...
    [Synchronized]
    public override DefaultInvoiceRate update(DefaultInvoiceRate defaultInvoiceRate)
    {
        ...
        raiseAffected(defaultInvoiceRate,DataMapperOperation.update);
  ...
  [TransactionRequired]
    ...
    public partial class BillItem: DomainObject
    {
      ...
      // parent tables
      protected BillItemComposition _relatedBillItemComposition;
    ...
    return uri;
      ...
      public int? BillItemCompositionId
      {
            ...
            set
            {
                      ...
                      if(!value.HasValue)
                        _relatedBillItemComposition = null;
                      else
                      {
                      if(_relatedBillItemComposition == null)
                        _relatedBillItemComposition = new BillItemComposition();

                        _relatedBillItemComposition.BillItemCompositionId = value.Value;
                      }
      ...
      public BillItemComposition RelatedBillItemComposition
      {
      get { return _relatedBillItemComposition;}
      set { _relatedBillItemComposition = value; }
      }
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      billItem.BillItemCompositionId = this.BillItemCompositionId;
      ...
      return billItem;
          ...
          // one to many relation
          private List<WorkLog> _relatedWorkLog;

          public List<WorkLog> relatedWorkLog
          {
          get { return _relatedWorkLog;}
          set { _relatedWorkLog = value; }
          }
          
          
          public WorkLog addRelatedWorkLogItem(
          WorkLog workLog)
          {
            workLog.RelatedBillItem = this;
            
            _relatedWorkLog.Add(workLog);
      ...
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
                  ...
                  sqlCommand.Parameters.AddWithValue("@notes", DBNull.Value);
                    ...
                    if(billItem.BillItemCompositionId.HasValue)
                  
                  sqlCommand.Parameters.AddWithValue("@billItemCompositionId", billItem.BillItemCompositionId);
                else
                  sqlCommand.Parameters.AddWithValue("@billItemCompositionId", DBNull.Value);
          ...
          if(billItem.relatedWorkLog != null 
            && billItem.relatedWorkLog.Count > 0)
          {
            WorkLogDataMapper dataMapper = new WorkLogDataMapper(Database);
            
            foreach(WorkLog item in billItem.relatedWorkLog)
              dataMapper.create(item);
          }
    ...
    billItem.BillItemId = (int) dataReader.GetValue(0);
          ...
          billItem.BillItemCompositionId = (int) dataReader.GetValue(9);
    ...
    protected override BillItem doLoad(Hashtable hashtable)
    {
      BillItem billItem = new BillItem();
        ...
        if(hashtable.ContainsKey("BillItemCompositionId"))
        billItem.BillItemCompositionId = ( int)hashtable["BillItemCompositionId"];
         ...
         using(SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand))
         {
            ...
            foreach(DataRow dataRow in dataTable.Rows)
            {
              BillItem item = new BillItem();
                  ...
                  if(!dataRow.IsNull("BillItemCompositionId"))
    ...
    public partial class WorkLog: DomainObject
    {
    
      protected int _workLogId;
    ...
    String uri = "TractIncRAID.WorkLog."
    ...
    public override DomainObject extractSingleObject()
    {
      ...
      workLog.WorkLogId = this.WorkLogId;
      workLog.BillItemId = this.BillItemId;
      workLog.LogMessage = this.LogMessage;
      workLog.ActiveRecordId = this.ActiveRecordId; 
      return workLog;
    }
    ...
    public abstract class _WorkLogDataMapper:TDataMapper<WorkLog,SqlConnection,TractIncRAIDDb, Weborb.Data.Management.MSSql.CommandBuilder, SqlTransaction, SqlCommand>
    {
      public _WorkLogDataMapper(){}
      public _WorkLogDataMapper(TractIncRAIDDb database):
      base(database){}
        public override String TableName
        {
          get
    ...
    private const String SqlCreate = @"Insert Into [dbo].[WorkLog] (
    ...
    [Synchronized]
    public override WorkLog create( WorkLog workLog )
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
        using(SqlCommand sqlCommand = Database.CreateCommand( SqlCreate ))
        {
                  ...
                  sqlCommand.Parameters.AddWithValue("@billItemId", workLog.BillItemId);
              
                    if(workLog.LogMessage != null)
                  
                  sqlCommand.Parameters.AddWithValue("@logMessage", workLog.LogMessage);
                else
                  sqlCommand.Parameters.AddWithValue("@logMessage", DBNull.Value);
              workLog.WorkLogId = int.Parse( sqlCommand.ExecuteScalar().ToString()) ;
      ...
      raiseAffected(workLog,DataMapperOperation.create);

      return registerRecord(workLog);
    }
    ...
    public WorkLog findByPrimaryKey(
    int workLogId
    )
    {
    using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
    ...
    using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
    {
          ...
          sqlCommand.Parameters.AddWithValue("@workLogId", workLogId);
      ...
      throw new DataNotFoundException("WorkLog not found, search by primary key");
 

    }


    public bool exists(WorkLog workLog)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlSelectByPk))
          {
                ...
                sqlCommand.Parameters.AddWithValue("@WorkLogId", workLog.WorkLogId);
    ...
    private const string CheckInSql = @"
      ...
      [WorkLog].[WorkLogId] = @CheckInWorkLogId";

    protected override IDbCommand PrepareCheckInCommand(DomainObject domainObject, string sqlQuery)
    {
      WorkLog _WorkLog = (WorkLog)domainObject;

       SqlCommand sqlCommand = Database.CreateCommand(ModifyQueryForCheckIn(sqlQuery,CheckInSql));

      
        sqlCommand.Parameters.AddWithValue("@CheckInWorkLogId", _WorkLog.WorkLogId);
    ...
    protected override WorkLog doLoad(IDataReader dataReader)
    {
    WorkLog workLog = new WorkLog();

    workLog.WorkLogId = (int) dataReader.GetValue(0);
            workLog.BillItemId = (int) dataReader.GetValue(1);
            
          if(!dataReader.IsDBNull(2))        
          workLog.LogMessage = (String) dataReader.GetValue(2);
    ...
    protected override WorkLog doLoad(Hashtable hashtable)
    {
      WorkLog workLog = new WorkLog();

      
        
        if(hashtable.ContainsKey("WorkLogId"))
        workLog.WorkLogId = ( int)hashtable["WorkLogId"];
          
        
        if(hashtable.ContainsKey("BillItemId"))
        workLog.BillItemId = ( int)hashtable["BillItemId"];
          
        
        if(hashtable.ContainsKey("LogMessage"))
        workLog.LogMessage = ( String)hashtable["LogMessage"];
    ...
    protected override List<WorkLog> fill(SqlCommand sqlCommand, int offset, int limit)
    {
        List<WorkLog> resultList = new List<WorkLog>();
         ...
         using(SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(sqlCommand))
         {
            ...
            foreach(DataRow dataRow in dataTable.Rows)
            {
              WorkLog item = new WorkLog();
                    ...
                    item.WorkLogId = ( int)dataRow["WorkLogId"] ;
                  
                    item.BillItemId = ( int)dataRow["BillItemId"] ;
                  
                  if(!dataRow.IsNull("LogMessage"))
                
                    item.LogMessage = ( String)dataRow["LogMessage"] ;
    ...
    #region Delete
    private const String SqlDelete = @"Delete From [dbo].[WorkLog]
    
      Where
      
        [WorkLogId] = @workLogId";
    [Synchronized]
    public override WorkLog remove(WorkLog workLog)
    {
      using (DatabaseConnectionMonitor monitor = new DatabaseConnectionMonitor(Database))
      {
          using(SqlCommand sqlCommand = Database.CreateCommand(SqlDelete))
      ...
      raiseAffected(workLog,DataMapperOperation.delete);
    ...
    [Synchronized]
    [TransactionRequired]
    public override WorkLog save( WorkLog workLog )
    {
      if(exists(workLog))
        return update(workLog);
        return create(workLog);
    }

  
      const String SqlUpdate = @"Update [dbo].[WorkLog] Set
    ...
    [Synchronized]
    public override WorkLog update(WorkLog workLog)
    {
        ...
        raiseAffected(workLog,DataMapperOperation.update);
