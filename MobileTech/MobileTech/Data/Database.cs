	...
	public static class Database
	{
        ...
        public static void ExecuteScript(String filePath)
        {
            ...
            if (!File.Exists(filePath))
                throw new MobileTechException("Stript file " + filePath + " not found");
            ...
            catch (Exception ex)
            {
                ...
                throw new MobileTechException(sqlBuffer.ToString(), ex); ;
            }
        }
...
#if WINCE
            if (IsDatabaseExist())
                throw new MobileTechException("Database already exists");
		...
		{
			IDbDataParameter dbParameter = CreateParameter(dbCommand, name, byteValue);
