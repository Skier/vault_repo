...
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[NotificationType]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[LeadStatus]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[TrackingPhone]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[TransactionType]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[PhoneBlackList]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[PartnerPhoneNumber]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[Campaign]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[Lead]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[User]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[Source]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[BusinessPartner]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[ActivityLog]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[Notification]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[PhoneCall]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[PhoneSms]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[Transaction]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[TrackingPhoneRotation]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[CompaignTrackingPhone]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[QbInvoice]') AND type in (N'U'))
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[WebForm]') AND type in (N'U'))
BEGIN
...
END
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PartnerPhoneNumber_BusinessPartner]') AND fkeyid = OBJECT_ID(N'[dbo].[PartnerPhoneNumber]'))
...
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Campaign_BusinessPartner]') AND fkeyid = OBJECT_ID(N'[dbo].[Campaign]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Campaign_User]') AND fkeyid = OBJECT_ID(N'[dbo].[Campaign]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Lead_BusinessPartner]') AND fkeyid = OBJECT_ID(N'[dbo].[Lead]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Lead_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[Lead]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Lead_LeadStatus]') AND fkeyid = OBJECT_ID(N'[dbo].[Lead]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Lead_Source]') AND fkeyid = OBJECT_ID(N'[dbo].[Lead]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_User_BusinessPartner]') AND fkeyid = OBJECT_ID(N'[dbo].[User]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Source_PhoneCall]') AND fkeyid = OBJECT_ID(N'[dbo].[Source]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Source_PhoneSms]') AND fkeyid = OBJECT_ID(N'[dbo].[Source]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Source_User]') AND fkeyid = OBJECT_ID(N'[dbo].[Source]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Source_WebForm]') AND fkeyid = OBJECT_ID(N'[dbo].[Source]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_BusinessPartner_User]') AND fkeyid = OBJECT_ID(N'[dbo].[BusinessPartner]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_ActivityLog_User]') AND fkeyid = OBJECT_ID(N'[dbo].[ActivityLog]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Notification_NotificationType]') AND fkeyid = OBJECT_ID(N'[dbo].[Notification]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneCall_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneCall]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneCall_PhoneBlackList]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneCall]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneCall_TrackingPhone]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneCall]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneCall_TrackingPhoneRotation]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneCall]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneSms_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneSms]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneSms_TrackingPhone]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneSms]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_PhoneSms_TrackingPhoneRotation]') AND fkeyid = OBJECT_ID(N'[dbo].[PhoneSms]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Transaction_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[Transaction]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Transaction_Source]') AND fkeyid = OBJECT_ID(N'[dbo].[Transaction]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_Transaction_TransactionType]') AND fkeyid = OBJECT_ID(N'[dbo].[Transaction]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_TrackingPhoneRotation_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[TrackingPhoneRotation]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_TrackingPhoneRotation_TrackingPhone]') AND fkeyid = OBJECT_ID(N'[dbo].[TrackingPhoneRotation]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_CompaignTrackingPhone_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[CompaignTrackingPhone]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_CompaignTrackingPhone_TrackingPhone]') AND fkeyid = OBJECT_ID(N'[dbo].[CompaignTrackingPhone]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_QbInvoice_Lead]') AND fkeyid = OBJECT_ID(N'[dbo].[QbInvoice]'))
...
GO
IF NOT EXISTS (SELECT * FROM sysforeignkeys WHERE constid = OBJECT_ID(N'[dbo].[FK_WebForm_Campaign]') AND fkeyid = OBJECT_ID(N'[dbo].[WebForm]'))
