...
namespace Dalworth.LeadCentral.Domain
{
    ...
    public partial class LeadStatus : ICloneable
    {
        ...
        public static LeadStatus Save(LeadStatus leadStatus, IDbConnection connection)
        {
        	if (!Exists(leadStatus, connection))
        		Insert(leadStatus, connection);
        	else
        		Update(leadStatus, connection);
        	return leadStatus;
        }

        public static LeadStatus Save(LeadStatus leadStatus)
        {
        	if (!Exists(leadStatus))
        		Insert(leadStatus);
        	else
        		Update(leadStatus);
        	return leadStatus;
        ...
        public static void Insert(LeadStatus leadStatus, IDbConnection connection)
        {
            using(IDbCommand dbCommand = Database.PrepareCommand(SqlInsert, connection))
            {
            	...
            	Database.PutParameter(dbCommand,"?StatusName", leadStatus.StatusName);
        ...
        public static void Insert(List<LeadStatus>  leadStatusList, IDbConnection connection)
        {
            using(IDbCommand dbCommand = Database.PrepareCommand(SqlInsert, connection))
            {
                ...
                else
                {
                	...
                	Database.UpdateParameter(dbCommand,"?StatusName",leadStatus.StatusName);
        ...
        public static LeadStatus Load(IDataReader dataReader, int offset)
        {
              ...
              leadStatus.Id = dataReader.GetInt32(0 + offset);
                  leadStatus.StatusName = dataReader.GetString(1 + offset);
        ...
        public static List<LeadStatus> Load(String xmlFilePath)
        {
        	XmlSerializer xmlSerializer = new XmlSerializer(typeof(LeadStatus));
            ...
            List<LeadStatus> itemsList = new List<LeadStatus>();
