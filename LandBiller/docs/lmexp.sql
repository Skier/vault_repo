-- ----------------------------
-- Table structure for "public"."tblclients"
-- ----------------------------

create sequence "tblclients_clientid_seq";
...
Source Database: LMEXP
Target Host: localhost
Target Database: LMEXP
Date: 12/8/2008 10:44:50 PM
*/
...
CREATE TABLE "public"."tblclients"(
"clientid" int8 NOT NULL DEFAULT nextval('tblclients_clientid_seq'::regclass),
