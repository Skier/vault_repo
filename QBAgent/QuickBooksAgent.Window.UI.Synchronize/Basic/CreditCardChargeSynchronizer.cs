...
{
    public class CreditCardChargeSynchronizer : Synchronizer<QBResponseCreditCardChargeReader,
                                      QBRequestCreditCardChargeWriter, CreditCard>
    {
        #region CreditCardChargeSynchronizer

        public CreditCardChargeSynchronizer()
        {
            m_name = "CC Charge";
        }
        ...
        protected override void OnProcessRequest(XmlWriter xmlWriter)
        {
            ...
            xmlWriter.WriteStartElement("CreditCardChargeQueryRq");
