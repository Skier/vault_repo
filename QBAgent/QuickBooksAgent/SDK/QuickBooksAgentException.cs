...
{
	public class QuickBooksAgentException:Exception,IEventInfo
	{
		...
		public QuickBooksAgentException(String message):base(message)
		{
			Init();
		}

		public QuickBooksAgentException(Exception e):base(e.Message,e)
		{
			Init();
		}

        public QuickBooksAgentException(String message,Exception innerExeption)
