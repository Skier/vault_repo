...
namespace DPI.Interfaces
{
	...
	public enum PayInfoSource { Unknown, Verifone, Wireless, FinProd, Energy }
	public enum PayInfoClass { PayInfo, PayInfoLocal }
	public enum PaymentStatus {Incomplete, Pend, PendConfirm, Paid, Cancelled, PendWireless, PendEnergy }

	// Product
	public enum ProdCategory { Internet, Wireless, Satellite, DpiWireless, DpiWirelessInt, DpiEnergy }
	...
	public enum DemandType 
	{
		...
		ReversalVoid, Wireless, LocalConv, Satellite, RecurringPymts, DpiWireless, DpiEnergy }	
	...
	public enum CertType { Debit_Card = 1, Basic_Web, Slingshot, DpiWireless }
...
//	public enum RW_SvcType { Dpi, Wir } // DPI = phone service, Wir = wireless
	...
	//Dpi_Wireless
	public enum DpiWLPlanStatus { Unknown, Fail, None, Active, Inactive, Suspended, Expended, Expired, Deactivated }
