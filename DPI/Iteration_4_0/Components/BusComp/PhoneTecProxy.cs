...
public class PhoneTecWS : System.Web.Services.Protocols.SoapHttpClientProtocol 
{
	...
	public PhoneTecWS() 
	{
		string urlSetting = System.Configuration.ConfigurationSettings.AppSettings["PhoneTechWebSvcURL"];
		if ((urlSetting != null)) 
		{
			this.Url = urlSetting;
		}
	...
	/// <remarks/>
	[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://192.168.30.12/PaceWS/PaceWS/SubmitTicket", RequestNamespace="http://192.168.30.12/PaceWS/PaceWS", ResponseNamespace="http://192.168.30.12/PaceWS/PaceWS", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
	public System.Xml.XmlNode SubmitTicket(string SubscriberID, string ESN, string MDN, string RequestInfo, string UserName, string Password) 
	{
	...
	/// <remarks/>
	public System.IAsyncResult BeginSubmitTicket(string SubscriberID, string ESN, string MDN, string RequestInfo, string UserName, string Password, System.AsyncCallback callback, object asyncState) 
	{
		return this.BeginInvoke("SubmitTicket", new object[] {
																 SubscriberID,
																 ESN,
																 MDN,
																 RequestInfo,
	...
	/// <remarks/>
	public System.Xml.XmlNode EndSubmitTicket(System.IAsyncResult asyncResult) 
	{
		object[] results = this.EndInvoke(asyncResult);
		return ((System.Xml.XmlNode)(results[0]));
	}
	...
	/// <remarks/>
	[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://192.168.30.12/PaceWS/PaceWS/RetrieveTicket", RequestNamespace="http://192.168.30.12/PaceWS/PaceWS", ResponseNamespace="http://192.168.30.12/PaceWS/PaceWS", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
	public System.Xml.XmlNode RetrieveTicket(string TicketID, string UserName, string Password) 
	{
		object[] results = this.Invoke("RetrieveTicket", new object[] {
																		  TicketID,
																		  UserName,
																		  Password});
		return ((System.Xml.XmlNode)(results[0]));
	...
	/// <remarks/>
	public System.IAsyncResult BeginRetrieveTicket(string TicketID, string UserName, string Password, System.AsyncCallback callback, object asyncState) 
	{
		return this.BeginInvoke("RetrieveTicket", new object[] {
																   TicketID,
																   UserName,
																   Password}, callback, asyncState);
	}
	...
	/// <remarks/>
	public System.Xml.XmlNode EndRetrieveTicket(System.IAsyncResult asyncResult) 
	{
		object[] results = this.EndInvoke(asyncResult);
		return ((System.Xml.XmlNode)(results[0]));
	}
	...
	/// <remarks/>
	[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://192.168.30.12/PaceWS/PaceWS/RetrieveAllTickets", RequestNamespace="http://192.168.30.12/PaceWS/PaceWS", ResponseNamespace="http://192.168.30.12/PaceWS/PaceWS", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
	public System.Xml.XmlNode RetrieveAllTickets(string ESN, string MDN, string SubscriberID, string UserName, string Password) 
	{
		object[] results = this.Invoke("RetrieveAllTickets", new object[] {
																			  ESN,
																			  MDN,
																			  SubscriberID,
																			  UserName,
	...
	/// <remarks/>
	public System.IAsyncResult BeginRetrieveAllTickets(string ESN, string MDN, string SubscriberID, string UserName, string Password, System.AsyncCallback callback, object asyncState) 
	{
		return this.BeginInvoke("RetrieveAllTickets", new object[] {
																	   ESN,
																	   MDN,
																	   SubscriberID,
																	   UserName,
	...
	/// <remarks/>
	public System.Xml.XmlNode EndRetrieveAllTickets(System.IAsyncResult asyncResult) 
	{
		object[] results = this.EndInvoke(asyncResult);
		return ((System.Xml.XmlNode)(results[0]));
	}
