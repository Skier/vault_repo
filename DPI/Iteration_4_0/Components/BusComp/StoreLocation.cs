...
namespace DPI.Components
{
    ...
    public class StoreLocation : DomainObj, IStoreLocation
    {
        ...
        private static string iName = "StoreLocation";
        ...
        private string wireless_PriceCode;
        private string notes;
        private string addLocInf;
        ...
        private int corpID;
        private string type;
        private int internet_Channel_ID;
        private bool localService;
        private bool wireless;
        private bool internet;
        private bool smartConnect;
        private decimal nET_FlatRate;
        private decimal sC_FlatRate;
        private decimal lS_FlatRate;
        private string divisional_Manager;
        private int overrideDebCardProd;
        private bool debitCard;
        private string restProd;
        private bool isNarrowPrinter;
        private bool satellite;
        private bool showSource;
        private bool dpiWireless;
        private bool dpiEnergy;
        ...
        public int OverrideDebCardProd
        {
            get { return overrideDebCardProd; }
        }
        ...
        public string RestProdRule
        {
            get { return restProd; }
        }

        public bool IsNarrowPrinter
        {
            get { return isNarrowPrinter; }
        }
        ...
        public bool DpiWireless
        {
            get { return dpiWireless; }
        }

        public bool DpiEnergy
        {
            get { return dpiEnergy; }
        }
        ...
        private static StoreLocation getOne(StoreLocation[] acls)
        {
            if (acls.Length == 1) {
                return acls[0];
            }
        ...
        internal static void copyAttrs(StoreLocation src, StoreLocation tar)
        {
            if (tar == null) {
        ...
        [Serializable]
        private class StoreLocationSQL : SqlGateway
        {
            private bool _gettingStates = false;
            private bool _gettingCities = false;
            ...
            private void setParam(SqlCommand cmd, StoreLocation rec)
            {
                ...
                //cmd.Parameters.Add("@DpiEnergy", SqlDbType.Bit, 0).Value = rec.dpiEnergy;
            }
...
//Removed to allow using old DB			    
//                    if (rdr["DpiEnergy"] != DBNull.Value) {
//                        rec.dpiEnergy = (bool) rdr["DpiEnergy"];
//                    }
                }
            ...
            private StoreLocation[] convert(DomainObj[] objs)
            {
