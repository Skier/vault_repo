...
namespace Dpi.Central.Web
{
    public sealed class SiteMap
    {
        ...
        public static string WRLS_ACCOUNT_SUMMARY_URL = AccountSiteUrl + "/wireless/summary.aspx";
        public static string WRLS_LOGIN_URL = AccountSiteUrl + "/wireless/login.aspx";

        // Recharge Differnet Plan Process
        public static string RDP_SELECT_PLAN_URL = AccountSiteUrl + "/wireless/rdp/select_plan.aspx";
        public static string RDP_SELECT_PRODUCTS_URL = AccountSiteUrl + "/wireless/rdp/select_products.aspx";
        public static string RDP_ORDER_SUMMARY_URL = AccountSiteUrl + "/wireless/rdp/order_summary.aspx";
        public static string RDP_PAY_CHECK_URL = AccountSiteUrl + "/wireless/rdp/check_payment.aspx";
        public static string RDP_PAY_CREDIT_CARD_URL = AccountSiteUrl + "/wireless/rdp/cc_payment.aspx";
        public static string RDP_RECEIPT_URL = AccountSiteUrl + "/wireless/rdp/receipt.aspx";
