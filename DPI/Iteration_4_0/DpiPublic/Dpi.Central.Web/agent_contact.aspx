...
if (document.frmContact.locations.value == "") {
	...
	<body>
		<form name="frmContact" method="post" runat="server" ID="Form1">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table2">
										...
										<tr>
											<td colspan="2" width="33%">
												<p align="center"><font face="Arial" color="#6b6b6b"> <span style="FONT-WEIGHT: 700"><font style="FONT-SIZE: 11px">
																dPi Teleconnect</font></span><span style="FONT-WEIGHT: 700; FONT-SIZE: 11px"><br>
