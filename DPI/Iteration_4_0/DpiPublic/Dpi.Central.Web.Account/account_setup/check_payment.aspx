...
<%@ Page language="c#" Codebehind="check_payment.aspx.cs" AutoEventWireup="false" Inherits="Dpi.Central.Web.Account.AccountSetup.CheckPaymentPage" %>
		...
		<form id="checkPaymentForm" method="post" runat="server">
			...
			<div class="process_form">
				...
				<div class="process_form_section">
					...
					<div class="row"><SPAN class="statement">By selecting the check box below, you are 
							agreeing to allow dPi Teleconnect to process a payment on a monthly basis by 
							using the Check information you provided today. We will automatically process 
							the payment every month on the Due Date indicated on your monthly statement. A 
							confirmation will be sent to the email address provided verifying if the 
							payment is accepted or denied.</SPAN><SPAN class="statement">
							<br>
							...
							the Check entry currently in an Active Status. Or you may contact our Customer 
							Service team to process this request. You are able to manage your recurring 
							payment method from your Online Account at any time. </SPAN>
					</div>
					<div class="row">
						<span class="value">
							<asp:CheckBox id="chkRecurringPayment" runat="server" Text="Use this checking account to process monthly recurring payments"></asp:CheckBox>
						</span>
					</div>
				...
				<div class="button_row">
					<span class="back_button">
						<asp:imagebutton id="m_btnBack" tabIndex="17" runat="server" ImageUrl="../images/btn_back.gif" EnableViewState="False"
