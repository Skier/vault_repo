...
namespace Dpi.Central.Web
{
    public class LocationsPage : Page
    {
        ...
        {
            this.ddlState.DataBinding += new EventHandler(this.ddlState_DataBinding);
            this.ddlState.SelectedIndexChanged += new EventHandler(this.ddlState_SelectedIndexChanged);
            this.ddlCity.DataBinding += new EventHandler(this.ddlCity_DataBinding);
            this.ddlCity.SelectedIndexChanged += new EventHandler(this.ddlCity_SelectedIndexChanged);
            this.dlStoreLocations.DataBinding += new EventHandler(this.dlStoreLocations_DataBinding);
            this.dlStoreLocations.ItemDataBound += new DataListItemEventHandler(this.dlStoreLocations_ItemDataBound);
