								...
								<tbody>
									...
									<tr>
										<td colspan="2"><asp:CustomValidator ID="vldCustErrorMsg" runat="server" ErrorMessage="" Display="None" EnableClientScript="False"
												Width="100%"></asp:CustomValidator><asp:ValidationSummary ID="vldSummary" runat="server" DisplayMode="List" CssClass="Error"></asp:ValidationSummary></td>
									</tr>
									<tr class="separator_row">
										<td colspan="2"></td>
									</tr>
									...
									<tr>
										...
										<td><ctl:textbox id="txtFName" runat="server" Width="100%" PerformValidation="True" IsRequired="True">Samuel</ctl:textbox></td>
									</tr>
									<tr>
										...
										<td><ctl:textbox id="txtLName" runat="server" Width="100%" PerformValidation="True" IsRequired="True">Sopilka</ctl:textbox></td>
									</tr>
									<tr>
										...
										<td><ctl:textbox id="txtAddr" runat="server" Width="100%" PerformValidation="True" IsRequired="True">112 Pobedy ave.</ctl:textbox></td>
									</tr>
									<tr>
										...
										<td>
											<table cellspacing="0" cellpadding="0" width="100%" border="0">
												<tr>
													<td width="45%"><ctl:textbox id="txtCity" runat="server" PerformValidation="True" IsRequired="True" ErrorMsgEmpty="Please enter City name"
															width="100%" ShowRequiredIndicator="False">Dallas</ctl:textbox></td>
													...
													<td width="1%"><img height="1" alt="" src="..\..\blank.gif" width="3"></td>
													<td width="28%"><ctl:textbox id="txtZIP" runat="server" PerformValidation="True" IsRequired="True" ErrorMsgEmpty="Please enter ZIP code"
															width="100%" ShowRequiredIndicator="False" ErrorMsgRegExp="Invalid ZIP code." ValidationRegExp="\d{5}(-\d{4})?"
															ValueType="RegExp">75025</ctl:textbox></td>
												</tr>
											</table>
										</td>
									</tr>
									<tr>
										...
										<td><ctl:textbox id="txtDrvNum" runat="server" Width="100%" PerformValidation="True" IsRequired="True"
												ErrorMsgEmpty="Please enter {0}" ErrorMsgRegExp="Please enter valid {0}" ValidationRegExp="\d+"
												ValueType="RegExp" EnableViewState="False"></ctl:textbox></td>
									</tr>
									<tr>
										...
										<td><asp:DropDownList ID="lstDrvState" runat="server" Width="100%" EnableViewState="False">
												<asp:ListItem Selected="True"></asp:ListItem>
									...
									<tr>
										...
										<td><ctl:textbox id="txtEmail" runat="server" Width="100%" PerformValidation="True" ErrorMsgEmpty="{0} cannot be empty"
												ErrorMsgRegExp="{0} is invalid" ValidationRegExp="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
												ValueType="RegExp" EnableViewState="False" IsRequired="True">samuel@sopilka.gov</ctl:textbox></td>
									</tr>
									<tr>
										...
										<td><ctl:textbox id="txtRNum" runat="server" Width="100%" PerformValidation="True" IsRequired="True"
												ErrorMsgEmpty="Please enter {0}" ErrorMsgRegExp="Please enter valid{0}" ValidationRegExp="[\d-]{9}"
												ValueType="Digits" EnableViewState="False"></ctl:textbox></td>
									</tr>
									<tr>
										...
										<td><ctl:textbox id="txtBANum" runat="server" Width="100%" PerformValidation="True" IsRequired="True"
												ErrorMsgRegExp="Invalid {0}. It should contain 3 or 4 digit." ValidationRegExp="\d{3-4}"
												ValueType="Digits" EnableViewState="False"></ctl:textbox></td>
									</tr>
									<tr class="separator_row">
										<td colspan="2"></td>
									...
									<tr>
										<td align="left">
											<asp:HyperLink id="lnkReturn" runat="server" NavigateUrl="~/account/payment/payment_selection.aspx">Return to payment selection</asp:HyperLink></td>
										<td align="right"><asp:ImageButton ID="btnPay" runat="server" EnableViewState="False" ImageUrl="../../images/proc_tran_btn.gif"
												AlternateText="Process Transaction"></asp:ImageButton></td>
									</tr>
									<tr class="separator_row">
										<td colspan="2"></td>
									</tr>
