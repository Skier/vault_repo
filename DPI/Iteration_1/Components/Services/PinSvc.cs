...
{	
	...
	#region Orders and Activations
		...
		static IPinReceipt Order(UOW uow, IUser user, IWebSvcQueue logQue, IPayInfo payInfo, IWireless_Products wp, IDemand dmd, string trNumber, ICellPhoneInfo cell)
		{
