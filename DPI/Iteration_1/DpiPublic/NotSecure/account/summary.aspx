				...
				<TR>
					...
					<TD vAlign="top" align="left">
						...
						<TABLE class="layout_table">
							...
							<TR>
								<TD class="left_padding"></TD>
								<TD style="HEIGHT: 11px" align="right" colSpan="2"><asp:label id="lblRecurringPymts" runat="server" Width="276px">Recurring Payments:</asp:label>&nbsp;
									<asp:linkbutton id="lbRecurringSetup" runat="server">(View)</asp:linkbutton></TD>
							</TR>
							<TR>
								<TD class="left_padding"></TD>
