...
namespace DPI.Reports {
    ...
    public class HI_ConvRecpt : ReportClass {
    ...
    public class CachedHI_ConvRecpt : Component, ICachedReport {
        
        public CachedHI_ConvRecpt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            HI_ConvRecpt rpt = new HI_ConvRecpt();
            rpt.Site = this.Site;
            return rpt;
        }
