...
namespace DPI.Reports {
    ...
    public class HI_Reciept : ReportClass {
    ...
    public class CachedHI_Reciept : Component, ICachedReport {
        
        public CachedHI_Reciept() {
        }
