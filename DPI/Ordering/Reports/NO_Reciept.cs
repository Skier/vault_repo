...
namespace DPI.Reports {
    ...
    public class NO_Reciept : ReportClass {
    ...
    public class CachedNO_Reciept : Component, ICachedReport {
        
        public CachedNO_Reciept() {
        }
