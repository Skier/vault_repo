				...
				<tr>
					<td align="center">
						<table cellSpacing="0" cellPadding="0" width="640" align="middle" border="0">
							...
							<tr>
								<td style="WIDTH: 529px">
									<asp:Label id="Label9" runat="server" Width="512px" Font-Names="Tahoma" Font-Bold="True" Font-Size="X-Small">4.	What icon provides you with the information on what promotions are available in customer’s service area?</asp:Label>
							...
							<tr>
								<td style="WIDTH: 529px">
									<asp:Label id="Label14" runat="server" Width="512px" Font-Names="Tahoma" Font-Bold="True" Font-Size="X-Small">9.	What report will provide you with a list of previous dPi customer’s with address information?</asp:Label>
