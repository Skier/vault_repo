<%@ Register TagPrefix="subhdr" TagName="subheader" Src="../Main/control/subheader.ascx" %>
<%@ Register TagPrefix="uc1" TagName="SiteFooter" Src="../Main/control/SiteFooter.ascx" %>
<%@ Register TagPrefix="uc1" TagName="SiteHeader" Src="../Main/control/ReceiptHeader.ascx" %>
<%@ Register TagPrefix="dPiUser" TagName="SideControl" Src="../Main/control/SideControl2.ascx" %>
<%@ Register TagPrefix="cr" Namespace="CrystalDecisions.Web" Assembly="CrystalDecisions.Web, Version=9.1.5000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" %>
<%@ Page language="c#" Codebehind="CertTrainingReport.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.Training.CertTrainingReport" %>
										...
										<TR>
											<td align="left" colSpan="2" height="219"><cr:crystalreportviewer id="ReportViewer" runat="server" Width="350px" Height="50px" Visible="False" DisplayGroupTree="False"></cr:crystalreportviewer><BR>
												<TABLE id="tblParameters" width="660" runat="server">
													<TR>
														<TD vAlign="top" align="center" width="168" height="166">Report by Store</TD>
														<TD vAlign="top" align="center" width="159" height="166">
															<asp:RadioButton id="rbtnStore" runat="server"></asp:RadioButton></TD>
														<TD vAlign="top" align="center" width="170" height="166"></TD>
														<TD vAlign="top" align="center" width="34" height="166"></TD>
														<td height="166"></td>
													</TR>
													<TR>
														<TD vAlign="top" align="center" width="168" height="145">Report by Corporation</TD>
														<TD vAlign="top" align="center" width="159" height="166">
															<asp:RadioButton id="rbtnCorp" runat="server"></asp:RadioButton></TD>
														<TD vAlign="top" align="center" width="170" height="145"></TD>
