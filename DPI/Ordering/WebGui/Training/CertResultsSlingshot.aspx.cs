...
{
	/// <summary>
	/// Summary description for CertResultsDCGen.
	/// </summary>
	public class CertResultsSlingshot : System.Web.UI.Page
	{
		...
		void btnGetCert_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			Server.Transfer("Certification_quiz_Slingshot.aspx", false);
		}
	}
}
