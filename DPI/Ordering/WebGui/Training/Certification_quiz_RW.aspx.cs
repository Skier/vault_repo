...
{
	public class Certification_quiz_RW : System.Web.UI.Page
	{
		Questions[] questions;
		...
		void LoadQuestions()
		{
			...
			Questions q = new Questions(Radiobuttonlist1, 0);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist2, 2);
			ar.Add(q);
            
			q = new Questions(Radiobuttonlist3, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist4, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist5, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist6, 0);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist7, 2);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist8, 2);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist9, 0);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist10, 1);
			ar.Add(q);
		...
		private void btnSubmit_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				for (int i = 0; i < questions.Length; i++)
				{
					...
					StoreSvc.SaveCertResult(IMapFactory.getIMap(), txtCoWorkerID.Text,  score / questions.Length > 0.69,
						txtName.Text, user.LoginStoreCode, (int)CertType.Basic_Web);
				...
				if(score < 7)
					...
					Response.Redirect("CertResultsRW.aspx?wrong=" + 
			...
			{
				ErrLogSvc.LogError(null, "Cert_Quiz", user.ClerkId, ex.Message);
