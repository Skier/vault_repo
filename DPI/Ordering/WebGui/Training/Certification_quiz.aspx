<%@ Page language="c#" Codebehind="Certification_quiz.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.Training.Certification_quiz" %>
				...
				<tr>
					<td align="center">
						<table cellSpacing="0" cellPadding="0" width="640" align="middle" border="0">
							...
							<tr>
								<td colspan="2" align="left" style="WIDTH: 529px"></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="WIDTH: 529px">
									<asp:Label id="Label9" runat="server" Width="512px" Font-Names="Tahoma" Font-Bold="True" Font-Size="X-Small">4.	What icon provides you with information on what promotions are available in a customer’s service area?</asp:Label>
							...
							<tr>
								<td style="WIDTH: 529px">
									<asp:Label id="Label13" runat="server" Width="384px" Font-Names="Tahoma" Font-Bold="True" Font-Size="X-Small"> 8. What report will you use to balance dPi with Hightouch?</asp:Label>
