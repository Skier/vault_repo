...
{
	public class Certification_quiz_Gen : System.Web.UI.Page
	{
		Questions[] questions;
		...
		void LoadQuestions()
		{
			...
			Questions q = new Questions(Radiobuttonlist1, 1);
			ar.Add(q);
			...
			q = new Questions(Radiobuttonlist4, 2);
			ar.Add(q);
			...
			q = new Questions(Radiobuttonlist8, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist9, 0);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist10, 2);
			ar.Add(q);
		...
		private void btnSubmit_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				if(score < 7)
					...
					Response.Redirect("CertResultsGen.aspx?wrong=" + 
