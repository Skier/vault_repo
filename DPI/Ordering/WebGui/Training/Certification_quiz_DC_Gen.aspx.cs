...
{
	public class Certification_quiz_DC_Gen : System.Web.UI.Page
	{
		Questions[] questions;
		...
		void LoadQuestions()
		{
			...
			q = new Questions(Radiobuttonlist3, 2);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist4, 0);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist5, 4);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist6, 0);
			ar.Add(q);
			
			q = new Questions(RadioButtonList7, 0);
			ar.Add(q);
			
			q = new Questions(RadioButtonList8, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist9, 1);
			ar.Add(q);
			
			q = new Questions(Radiobuttonlist10, 1);
			ar.Add(q);

			q = new Questions(Radiobuttonlist11, 3);
			ar.Add(q);
					
			q = new Questions(Radiobuttonlist12, 1);
			ar.Add(q);
		...
		private void btnSubmit_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				StoreSvc.SaveCertResult(IMapFactory.getIMap(), txtCoWorkerID.Text,  score / questions.Length > 0.69,
					txtName.Text, user.LoginStoreCode, (int)CertType.Debit_Card);
				...
				Response.Redirect("CertResultsDCGen.aspx?wrong=" + 
