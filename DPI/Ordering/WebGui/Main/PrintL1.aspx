<%@ Page language="c#" Codebehind="PrintL1.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.PrintL1" %>
	...
	<body text="#000000" bgColor="#ffffff" leftMargin="0" topMargin="0">
		<form id="form_ProductL1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="510" border="0">
				...
				<tr>
					<td align="center" height="34"><asp:label id="lblDate" runat="server" Width="373px"></asp:label>ZipCode:
						<asp:label id="lblZipCode" runat="server" BackColor="White"></asp:label>&nbsp;&nbsp;&nbsp;
						<asp:label id="lblIlec" runat="server" BackColor="White"></asp:label>&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="05_con_medium" vAlign="top" colSpan="2" height="138">
						...
						<P align="center">&nbsp;</P>
						<P align="center">&nbsp;</P>
						<P align="center"><asp:label id="Label1" runat="server" Width="398px">
								<STRONG><FONT face="Arial" color="chocolate" size="2"><FONT size="3">&nbsp;&nbsp;&nbsp; *</FONT></FONT><FONT face="Arial" color="dimgray" size="2">Prompt 
										...
										due date.</FONT></STRONG><br>
								<STRONG><FONT size="2"><FONT face="Arial" color="chocolate">&nbsp;&nbsp;&nbsp; * *</FONT><FONT face="Arial" color="dimgray">Price 
											based on Prompt Pay Discount.</FONT></FONT></STRONG><FONT face="Arial" color="dimgray"><STRONG><FONT size="2">&nbsp;Does 
											not apply to initial payment. </FONT></STRONG>
							</asp:label></P>
					</td>
				</tr>
				<tr>
