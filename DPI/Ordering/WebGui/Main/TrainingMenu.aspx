<%@ Page language="c#" Codebehind="TrainingMenu.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.Training.TrainingMenu" %>
...
<HTML>
	<HEAD>
		<title>Rent-A-Center Training Menu</title> 
		<!---
							...
							<tr>
								<td vAlign="middle" align="right" colspan="4" background="images/subheader_agenttraining.jpg"
									...
									<asp:Label id="Label1" runat="server" ForeColor="Black" Font-Bold="True" Font-Size="Medium"
										Font-Names="Tahoma" Width="376px">Rent-A-Center Agent Training Program</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td vAlign="bottom" align="center" colspan="4">&nbsp;</td>
							</tr>
							<tr>
								<td width="64" height="102">&nbsp;</td>
								...
								<td valign="top" height="102">
									<P>&nbsp;&nbsp;
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:Label id="Label3" runat="server" Width="312px" ForeColor="SteelBlue">Click this button to learn about WebCentral. </asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:LinkButton id="LinkButton1" runat="server" Font-Names="Arial" Font-Size="X-Small" Font-Bold="True"
											ForeColor="Red" Font-Underline="True" Font-Italic="True">HighTouch Tutorial</asp:LinkButton></P>
								</td>
								<td rowspan="3">&nbsp;
