...
{
	public class Store_WirelessCommission : System.Web.UI.Page
	{
		protected DPI.Interfaces.Store_CommissionCriteria reportCriteria;		
		protected DPI.Reports.Store_WireLessCommission oRpt;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{  		
				...
				lblRptTitle.Text = Store_CommissionReportFactory.GetTitle(reportCriteria);
			}
			...
			this.imgInstruction1.Attributes.Add("onClick", "window.alert('" + (string)Store_CommissionReportFactory.GetInstructions(reportCriteria)[0] + "');");			
			this.imgInstruction2.Attributes.Add("onClick", "window.alert('" + (string)Store_CommissionReportFactory.GetInstructions(reportCriteria)[1] + "');");			
		...
		override protected void OnInit(EventArgs e)
		{
			InitializeComponent();
			base.OnInit(e);
			reportCriteria = (Store_CommissionCriteria)int.Parse(Request.QueryString["reportcriteria"]);	
		}		
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			if(IsPostBack)
			{
				...
				{						
					try
					{
						oRpt = new DPI.Reports.Store_WireLessCommission();	
						string s = Store_CommissionReportFactory.GetTitle(reportCriteria);
						oRpt.SummaryInfo.ReportTitle = Store_CommissionReportFactory.GetTitle(reportCriteria);
						oRpt.SetDataSource(Store_CommissionReportFactory.GetDataSource(reportCriteria, 
