...
{
	public class Store_CustomerList : System.Web.UI.Page

	{
		#region Member Variables
		protected DPI.Interfaces.Store_CustomerListCriteria reportCriteria;
		protected DPI.Reports.Store_CustomerList oRpt;
		...
		override protected void OnInit(EventArgs e)
		{
			InitializeComponent();
			base.OnInit(e);
			reportCriteria = (Store_CustomerListCriteria)int.Parse(Request.QueryString["reportcriteria"]);			
		}		
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{  		
				...
				lblRptTitle.Text = Store_CustomerListReportFactory.GetTitle(reportCriteria);
			}
			...
			this.imgInstruction1.Attributes.Add("onClick", "window.alert('" + (string)Store_CustomerListReportFactory.GetInstructions(reportCriteria)[0] + "');");			
			this.imgInstruction2.Attributes.Add("onClick", "window.alert('" + (string)Store_CustomerListReportFactory.GetInstructions(reportCriteria)[1] + "');");			
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			if(IsPostBack)
			{
				...
				{						
					try
					{
						oRpt = new DPI.Reports.Store_CustomerList();						
						oRpt.SummaryInfo.ReportTitle = Store_CustomerListReportFactory.GetTitle(reportCriteria);
						oRpt.SetDataSource(Store_CustomerListReportFactory.GetDataSource(reportCriteria, 
