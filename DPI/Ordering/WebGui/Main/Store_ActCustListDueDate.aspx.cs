...
{
	public class Store_ActCustListDueDate : System.Web.UI.Page
	{
		#region Member Variables
		protected DPI.Interfaces.Store_OrderStatusCriteria reportCriteria;		
		protected DPI.Reports.Store_ActCustListByDueDate oRpt;
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			if(IsPostBack)
			{
				...
				{						
					try
					{
						oRpt = new DPI.Reports.Store_ActCustListByDueDate();						
