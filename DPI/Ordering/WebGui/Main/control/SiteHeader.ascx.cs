namespace DPI.Ordering.Control
{
	...
	#region Data
		...
		protected System.Web.UI.WebControls.Label lblNavErr;
	...
	#region Event Handlers
		private void CustomInit()
		{
			foreach(object ctrl in Controls)
				if (ctrl is System.Web.UI.WebControls.ImageButton)
					((System.Web.UI.WebControls.ImageButton)ctrl).Attributes
						.Add("onClick", "clickedButton=true; ");
		}

		private void Page_Load(object sender, System.EventArgs e)
		{
			lblVersion.Text = "version: 4.2.0.0";
			btnImgLogout.Attributes.Add("onClick", "clickedButton=true; ");
		...
		private void NewOrder_Click(object sender, System.EventArgs e)
		{
			...
			//	WIP wip = new NewOrderWip(HttpContext.Current.User.Identity.Name);
