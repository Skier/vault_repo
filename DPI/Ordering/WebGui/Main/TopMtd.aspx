<%@ Page language="c#" Codebehind="TopMtd.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.TopMtd" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>New Sales Rank</title>
							...
							<tr>
								<td align="center">
									<asp:Label id="lblRank" runat="server" Font-Names="Arial" Font-Bold="True" ForeColor="#C00000"
										Font-Size="Small">New Sales Rank</asp:Label></td>
							</tr>
							<tr>
								<td>
