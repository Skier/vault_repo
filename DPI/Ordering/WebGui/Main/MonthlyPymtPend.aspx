<%@ Page language="c#" Codebehind="MonthlyPymtPend.aspx.cs" AutoEventWireup="false" Inherits="DPI.Ordering.MonthlyPymtPend" %>
	...
	<body text="#000000" bgColor="#ffffff" leftMargin="0" topMargin="0" ms_positioning="GridLayout">
		<form id="Form1" onsubmit="return check(); " action="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="800" align="left" border="0">
				...
				<tr>
					<td vAlign="top" align="center" width="129" background="images/sidenav_bgd.gif" bgColor="white"
						height="100%" style="WIDTH: 129px"><dpiuser:sidecontrol id="Sidecontrol2" runat="server"></dpiuser:sidecontrol></td>
							...
							<tr>
								<td class="05_con_sublabel_zip" vAlign="middle" align="left" background="images/subtable_header_blank.jpg"
									...
									<asp:label id="Label5" runat="server" Height="22px" Font-Bold="True" Font-Names="Arial" Font-Size="Small"
										ForeColor="Chocolate" Width="336px">Customer Information / Review</asp:label></td>
							</tr>
							<tr>
								<td vAlign="top" colSpan="5">
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											...
											<td style="WIDTH: 288px; HEIGHT: 3px" align="right"></td>
										...
										<tr>
											<td style="WIDTH: 22px; HEIGHT: 20px">&nbsp;</td>
											<td style="WIDTH: 288px; HEIGHT: 20px" align="left"></td>
											<td align="right" bgColor="whitesmoke" style="HEIGHT: 20px"><asp:image id="imgSignal" runat="server" ImageUrl="images/signal.gif" Visible="False"></asp:image>&nbsp;&nbsp;
												<asp:label id="lblAmtColError" runat="server" ForeColor="Red">*</asp:label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
											<td style="HEIGHT: 20px">&nbsp;</td>
										</tr>
									</table>
