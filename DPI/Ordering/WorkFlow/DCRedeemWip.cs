...
namespace DPI.Ordering
{
	...
	public class DCRedeemWip : WIP
	{
		...
		/*		Properties		*/
		public override IWipStep FirstStep { get { return WorkflowFact.DebCardRedeemFirstStep(); }}
		...
		/*		Constructors		*/
		public DCRedeemWip(string user, string clerkId, string storeCode) : base(user, clerkId, storeCode)
		{
