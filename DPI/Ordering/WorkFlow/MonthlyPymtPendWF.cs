...
{
	public class MonthlyPymtPendWF : IWorkflow
	{
		...
		MonthlyPymtPendWF()
		{
			...
			WIP.WipStep accountSummary = new WIP.WipStep(this, "Customer Payment", "MonthlyPymtPend.aspx");  
		...
		{
			MonthlyPymtPendWF wf;
			if (steps == null)
				wf = new MonthlyPymtPendWF();
		}
	}
}			