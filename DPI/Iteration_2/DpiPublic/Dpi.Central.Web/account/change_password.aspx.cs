...
namespace Dpi.Central.Web.Account
{
    public class ChangePasswordPage : BaseAccountPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PreRender += new System.EventHandler(this.ChangePasswordPage_PreRender);
        }
        ...
        {
            vldCustErrorMsg.IsValid = false;
            vldCustErrorMsg.ErrorMessage += "<li>" + msg + "</li>" + Environment.NewLine;
        }

        private void ChangePasswordPage_PreRender(object sender, EventArgs e)
        {
            if (!vldCustErrorMsg.IsValid) {
                vldCustErrorMsg.ErrorMessage = "<ul>" + vldCustErrorMsg.ErrorMessage + "</ul>";
            }
        }
