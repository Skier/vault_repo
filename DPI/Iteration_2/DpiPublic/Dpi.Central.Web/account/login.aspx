				...
				<TR>
					...
					<TD vAlign="top" align="left">
						...
						<TABLE class="layout_table">
							...
							<TR>
								<TD></TD>
								<TD><asp:HyperLink id="lnkForgotMyPassword" runat="server" NavigateUrl="~/PasswordReminder.aspx" Font-Underline="True">Forgot My Password</asp:HyperLink></TD>
								<TD></TD>
							</TR>
							<TR>
								<TD></TD>
								<TD><asp:HyperLink id="lnkSignUp" runat="server" NavigateUrl="~/signup.aspx" Font-Underline="True">Web Access Sign Up</asp:HyperLink></TD>
								<TD></TD>
							</TR>
						</TABLE>
					</TD>
