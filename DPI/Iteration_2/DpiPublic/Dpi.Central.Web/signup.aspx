					...
					<TD vAlign="top" align="left">
						...
						<TABLE class="layout_table">
							...
							<TR>
								<TD></TD>
								<TD>
									<asp:LinkButton id="lnkSummary" runat="server" Visible="False" Font-Underline="True">Return to Account Summary</asp:LinkButton><br>
									<asp:HyperLink id="lnkLogin" runat="server" NavigateUrl="~/account/login.aspx" Font-Underline="True">Return to Login</asp:HyperLink></TD>
								<TD width="35%"></TD>
							</TR>
						</TABLE>
					</TD>
