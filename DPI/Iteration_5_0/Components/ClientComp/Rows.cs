...
namespace DPI.ClientComp
{
    ...
    public class ProductSummaryTableHeader : TableRow
    {
        public ProductSummaryTableHeader() : base() 
        {
            BackColor = Color.Chocolate ;
	...
	public class HeaderDpiEng : TableRow 
	{
		public HeaderDpiEng() : base() 
		{
			BackColor = Color.Chocolate ;
			
			// Package & Features col
			TableCell cell       = new TableCell();
			cell.Text            = "&nbsp;&nbsp;Feature description";
			cell.HorizontalAlign = HorizontalAlign.Left;
			cell.Font.Bold       = true;
			cell.ForeColor       = Color.White;
			cell.ColumnSpan		 = 2;
    ...
    public class ProductSummaryTableRow : TableRow
    {
        private const string CSS_CLASS = "subitems";

        private LinkButton _modifyLinkButton;
        private LinkButton _removeLinkButton;
        private IProdPrice _product;

        private Hashtable _idTable = new Hashtable();

        public ProductSummaryTableRow(IProdPrice product, Color back) : base()
        {
            _product = product;
            ...
            cell.CssClass = CSS_CLASS;
            cell.HorizontalAlign = HorizontalAlign.Left;
            cell.Text = product.PackageId > 0 ? Const.COMP_INDENT + product.BillText : "&nbsp;&nbsp;" + product.BillText;
            cell.Width = Unit.Percentage(52);
            Cells.Add(cell);
            ...
            cell.CssClass = CSS_CLASS;
            cell.HorizontalAlign = HorizontalAlign.Right;
            cell.Text = OrderSummaryProdFormatter.FormatPrice(product, 1);
            cell.Width = Unit.Percentage(12);
            Cells.Add(cell);
            ...
            cell.CssClass = CSS_CLASS;
            cell.HorizontalAlign = HorizontalAlign.Right;
            cell.Text = OrderSummaryProdFormatter.FormatPrice(product, 2);
            cell.Width = Unit.Percentage(18);
            Cells.Add(cell);
            ...
            cell.CssClass = CSS_CLASS;
            cell.HorizontalAlign = HorizontalAlign.Right;
            _modifyLinkButton = new LinkButton();
            _modifyLinkButton.ID = GetNextId("modifyLinkButton_", product);
            _modifyLinkButton.Text = "Modify";
            cell.Controls.Add(_modifyLinkButton);
            ...
            cell.CssClass = CSS_CLASS;
            cell.HorizontalAlign = HorizontalAlign.Right;
            _removeLinkButton = new LinkButton();
            _removeLinkButton.ID = GetNextId("removeLinkButton_", product);
            _removeLinkButton.Text = "Remove";
            cell.Controls.Add(_removeLinkButton);
            cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
            cell.Width = Unit.Percentage(9);
            Cells.Add(cell);
        }

        private string GetNextId(string prefix, IProdPrice product)
        {
            string id = prefix + product.ProdId;

            if (!_idTable.Contains(id)) {
                _idTable.Add(id, null);
                return id;
            }
        ...
        public LinkButton ModifyLinkButton
        {
            get { return _modifyLinkButton; }
        }

        public LinkButton RemoveLinkButton
        {
            get { return _removeLinkButton; }
        }

        public IProdPrice Product
        {
            get { return _product; }
        }
    }
	...
	public class DpiWLProdRow : TableRow 
	{
        ...
        public class DpiEngOrdSumRow : TableRow 
	{
		const string CSS_CLASS = "subitems";

		public DpiEngOrdSumRow(string name, string unit, Color back) : base() 
		{	
			BackColor = back;
	...
	public class AddressListRow : TableRow
	{
		public AddressListRow(ServiceLocation data, Color backColor): base()
		{
			const string BUTTON_GROUP = "ButtonGroup";
			BackColor = backColor;
			HorizontalAlign = HorizontalAlign.Center;
			...
			button.GroupName   = BUTTON_GROUP;			
			button.ID          = data.SiteCode;
			button.Attributes.Add("OnClick", "SetSelESIID(this.value)");
			//button.EnableViewState = button.AutoPostBack =  true;
			//button.CheckedChanged += eh;
			button.Text = data.SiteCode;
			
			TableCell c0 = new TableCell();				
			c0.Controls.Add(button);
			Cells.Add(c0);
...
//			Cells.Add(c1);
	...
	public class CustListRow : TableRow
	{
		public CustListRow(IEnergy_CustData data, Color backColor): base()
		{
			const string BUTTON_GROUP = "ButtonGroup";
			BackColor = backColor;
			HorizontalAlign = HorizontalAlign.Center;
			...
			button.Attributes.Add("OnClick", "SetCustID(this.value)");
			button.Text = data.AccountNumber.ToString();
			...
			TableCell c2 = new TableCell();
			c2.Text = data.NameLast + ", " + data.NameFirst;
			Cells.Add(c2);

			TableCell c3 = new TableCell();
			c3.Text = data.FullMailingAddress;;
			Cells.Add(c3);
    ...
    public class TaxDetailsHeader : TableRow 
    {
        public TaxDetailsHeader(int month, Color backcolor) : base() 
        {
            TableCell cell = new TableCell();

            cell.Text = "&nbsp;&nbsp;Tax Details: Month " + month;
            cell.HorizontalAlign = HorizontalAlign.Left;
            cell.ForeColor = Color.White;
            cell.BackColor = backcolor;
            cell.Font.Bold = true;
    ...
    public class TaxDetailsRow : TableRow 
    {
        public TaxDetailsRow(string row, Color backColor) : base() 
        {
            TableCell cell = new TableCell();
