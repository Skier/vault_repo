...
namespace DPI.Components
{
    ...
    public class PaymentServiceProviderException : Exception
    {
        ...
        public PaymentServiceProviderException(PaymentResult paymentResult) : base ()
        {
 ...
 #region Request Fields
            ...
            int accountNumber, CreditCard creditCard, decimal paymentAmount)
        {
            ...
            string merchantId = ConfigurationSettings.AppSettings["CreditCardMerchantId"];
            parameters.Add(MERCHANT_CODE, merchantId); 
			
            string testValue = ConfigurationSettings.AppSettings["test"];
			parameters.Add(TEST_MODE, testValue);

            parameters.Add(PAYMENT_SOURCE, "Web");
            parameters.Add("employee_number", "1234");
        ...
        public virtual PaymentResult MakeCheckPayment(int accountNumber,BankCheck bankCheck, decimal paymentAmount)
        {
            ...
            string merchantId = ConfigurationSettings.AppSettings["CheckMerchantId"];
            parameters.Add(MERCHANT_CODE, merchantId);
