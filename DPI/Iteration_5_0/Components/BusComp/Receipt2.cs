...
namespace DPI.Components
{
	...
	#region Static methods
		...
		public static IReceipt2 find
			(UOW uow, string provider, string prodGroup, int prod, int wlProd, int corp, string store, string workflow, bool isCompleted)
        {
			int rctId = ReceiptSelRule.GetReceiptId(uow, provider, prodGroup, prod, wlProd, corp, store, workflow, isCompleted);
