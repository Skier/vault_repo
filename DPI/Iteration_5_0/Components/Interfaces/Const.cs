...
namespace DPI.Interfaces
{
	public class Const
	{
		...
		// YONIX
		private const string _YONIX_USERID     = @"web-system"; //User displayed in the VB 6.0 Yonix application for the account information logs. 
		private const string _YONIX_DEPARTMENT = @"web-system"; //Department displayed in the VB 6.0 Yonix application for the account information logs.

	    public static string YONIX_USERID
	    {
	        get
	        {
	            string rv = ConfigurationSettings.AppSettings["YonixUserId"];
	            if (rv == null)
	                return _YONIX_USERID;
	            else
	                return rv;
	        }
	    }
	    
	    public static string YONIX_DEPARTMENT
	    {
            get {
                string rv = ConfigurationSettings.AppSettings["YonixDepartment"];
                if (rv == null)
                    return _YONIX_DEPARTMENT;
                else
                    return rv;
            }
        }
        ...
        public const string PUBLIC_WEB_USERID = @"web-user";	    
		...
		public const string CHECK_PLAN_STATUS		= "check_plan_status";
		...
		public const string ORDER_PIN				= "order_pin";
		...
		public const string PHONETEC		  = "phonetecpcs";
		public const string TELISPIRE		  = "telispire";

		// Energy service providers
		public const string EPSOLUTIONS		  = "epsolutions";
		...
		//ePsolutions Constants
		public const string CRDUNS					= "785092292";
