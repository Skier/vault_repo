...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[spOrder_getIlecsAll]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
    DROP PROCEDURE [dbo].[spOrder_getIlecsAll]
GO
...
-- Create SP: spAccountSummary_Get_Id

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[spAccountSummary_Get_Id]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
    DROP PROCEDURE [dbo].[spAccountSummary_Get_Id]
GO
...
IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('VerbatumServiceAddress') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustData') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN    
    ALTER TABLE [dbo].[CustData]
        ADD [VerbatumServiceAddress] [VARCHAR] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
END

IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('VerbatumMailingAddress') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustData') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN  
    ALTER TABLE [dbo].[CustData]
...
ALTER  PROCEDURE [dbo].[spCustData_Ins]
    ...
    @VerbatumServiceAddress varchar(200),
    @VerbatumMailingAddress varchar(200)
AS    
    BEGIN TRANSACTION
...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[spPayment_Get_AllByAccNumber]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
    DROP PROCEDURE [dbo].[spPayment_Get_AllByAccNumber]
GO
...
IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('CLLI') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustAddress') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN
    ALTER TABLE [dbo].[CustAddress]
        ADD [CLLI] [VARCHAR] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
END

IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('NPANXX') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustAddress') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN
    ALTER TABLE [dbo].[CustAddress]
...
-- Alter SP: [dbo].[spCustAddress_Ins]
...
-- Alter SP: [dbo].[spCustAddress_Upd]
...
-- Alter SP: [dbo].[spCustAddress_Get_Id]
...
IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('Language') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustInfo') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN
    ALTER TABLE CustInfo
        ADD [Language] [VARCHAR] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
END

IF NOT EXISTS (SELECT * FROM syscolumns WHERE [name] IN ('ActivationDate') AND [id] = 
    (SELECT [id] FROM sysobjects WHERE id = object_id(N'CustInfo') AND OBJECTPROPERTY(id, N'IsTable') = 1))
BEGIN
    ALTER TABLE CustInfo
...
-- Alter SP: [dbo].[spCustInfo_Get_Id]
