...
namespace Dpi.Central.Web.Controls
{
	public class MenuFactory
	{
        ...
        public Menu CreateMenu()
        {
            ...
            subMenu.Items.Add(new Menu.SubMenuItem("Sign&nbsp;Up", accountSiteUrl + "/signup.aspx"));
            ...
            if (authenticated) {
                if (HttpContext.Current.User.IsInRole(AuthenticationHelper.HOME_PHONE_ACCOUNT)) {
                    ...
                    subMenu.Items.Add(new Menu.SubMenuItem("Account&nbsp;Summary", accountSiteUrl + "/wireless/service_info.aspx"));
                }
            }
