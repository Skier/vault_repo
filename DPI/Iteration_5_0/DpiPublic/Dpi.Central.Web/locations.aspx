	...
	<body>
		<form id="storeLocationForm" method="post" runat="server">
			<TABLE height="1" cellSpacing="0" cellPadding="0" border="0">
				<TR>
					...
					<TD vAlign="top" align="left">
						...
						<TABLE class="layout_table">
							<tr>
								<td class="title_1" colSpan="3">Please select a city and state to locate a dPi 
									reseller near you.
								</td>
							</tr>
							...
							<TR>
								<TD colSpan="3"><asp:label id="lblHeader" runat="server" Width="100%" CssClass="title_2">Title</asp:label></TD>
							</TR>
							<TR>
				...
				<TR>
					<TD vAlign="bottom" class="page_footer">
						<dwc:Footer id="_footer" runat="server"></dwc:Footer></TD>
				</TR>
			</TABLE>
		</form>
	</body>
