						...
						<table border="0" cellpadding="0" cellspacing="0" id="table2">
							<tr>
								<td colspan="2">
									<table width="637" height="201" border="0" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td style="BACKGROUND-IMAGE:url(images/ppc_top2.gif)" height="19" colspan="3"></td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" class="contentTd">
									<p class="hdr">Plans</p>
									<p class="txt">Our plans are designed to grow with you as your needs change.&nbsp; 
										So once you choose dPi Pre-Paid cellular, you’ll never have to choose another 
										cellular provider again.</p>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="contentTd"><table width="636" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="198" valign="top"><table border="0" cellspacing="0" cellpadding="2">
													...
													<tr>
														<td class="planNameTD"><p>25 Anytime Minutes
															</p>
														</td>
											...
											<td width="233" valign="top"><table border="0" cellspacing="0" cellpadding="2">
												...
												<table border="0" cellspacing="0" cellpadding="2">
													<tr>
														<td colspan="2" class="hdrs">Text Messages
														</td>
													</tr>
													<tr>
											...
											<td width="205" rowspan="2" valign="top"><p class="hdrs">Control Your Wireless!
												</p>
												<p class="txt">When your minutes get low, you will&nbsp;recieve a&nbsp;text message 
													on&nbsp;your phone and you decide weather or&nbsp;not you to add more minutes 
													by&nbsp;using a cash card, loading a&nbsp;new service plan or just wait until 
													your next monthly plan starts.
												</p>
												<table border="0" cellspacing="0" cellpadding="2">
													<tr>
														<td colspan="2" class="hdrs">Text Messages
										...
										<tr>
											<td colspan="2" valign="bottom"><a href="contact.aspx"><img src="images/ppc_readytosign.gif" alt="Ready to sign?" width="425" height="63" border="0"
														style="MARGIN-TOP:6px"></a></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="contentTd"><br>
									<p class="hdr">Phones</p>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<p style="MARGIN-BOTTOM: 5px; MARGIN-LEFT: 20px; MARGIN-RIGHT: 8px">
										<font face="Arial" style="FONT-SIZE: 11px" color="#6b6b6b"><span style="FONT-WEIGHT: 700">
												Choose from our great selection of cool phones.<br>
											</span></font><font face="Arial" color="#6b6b6b" size="1">* Call '1-877 Join 
											dPi' or visit an authorized dPi reseller for phone pricing and availability</font></p>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<table border="0" cellpadding="5" cellspacing="0">
										<tr>
											<td>
												<img src="images/ppc_sanyo2400.gif" alt=""></td>
											<td>
												<img src="images/ppc_sanyo_katana.gif" alt=""></td>
											<td>
												<img src="images/ppc_lg225.gif" alt=""></td>
										</tr>
									</table>
								</td>
							</tr>
						</table>
						<p style="FONT-SIZE: 11px">DPI Teleconnect is an authorized agent of Telispire. 
							Through its arrangement with Telispire, DPI Teleconnect wireless network 
							services are provided on the Nationwide Sprint PCS Network.*</p>
						<p style="FONT-SIZE: 11px">
							Although Telispire provides DPI Teleconnect subscribers access to the 
							Nationwide Sprint PCS Network and to its wireless services, Telispire is 
							responsible to the DPI Teleconnect subscribers for the service. Please call 
							Telispire with any questions or comments about services.</p>
						<p style="FONT-SIZE: 10px; MARGIN-BOTTOM: 10px">*Sprint is a trademark of Sprint 
							Nextel.</p>
					</td>
				</tr>
				<tr>
