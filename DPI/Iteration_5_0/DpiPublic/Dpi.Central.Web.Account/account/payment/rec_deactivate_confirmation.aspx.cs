...
namespace Dpi.Central.Web.Account.Payment
{
    public class DeactivateConfirmationPage : BaseRecurringPaymentPage
    {
        ...
        const string CONFIRMATION_FORMAT = "An Active recurring payment option already exist with {0} Number ending in {1}. Do you want to deactivate the existing recurring payment option and make this one active?";
