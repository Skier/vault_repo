...
namespace Dpi.Central.Web.Account.Payment
{
    public class CheckInfoControl : UserControl
    {
        ...
        {
            set { vldCstBankRouteNumber.Enabled = vldRfBankAccountNumber.Enabled = vldReBankAccountNumber.Enabled = vldRfBankRouteNumber.Enabled = vldReBankRouteNumber.Enabled = vldRfDrvLicState.Enabled = vldRfDrvLicNumber.Enabled = value; }
        }
