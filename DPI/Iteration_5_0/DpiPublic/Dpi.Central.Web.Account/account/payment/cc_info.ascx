...
<div class="row"><span class="label">CVV2 Security Code<IMG alt="" src="~/images/asterisk.gif" runat="server"><br>
		...
		<asp:textbox id="txtCvNumber" runat="server" CssClass="wide_field"></asp:textbox><asp:requiredfieldvalidator id="vldRfCvNumber" runat="server" ErrorMessage="Required field cannot be left blank"
			Display="Dynamic" ControlToValidate="txtCvNumber"></asp:requiredfieldvalidator>
		<asp:RegularExpressionValidator id="vldReCvNumber" runat="server" ErrorMessage="The CVV2 Security Code is invalid"
			Display="Dynamic" ControlToValidate="txtCvNumber" ValidationExpression="^\d{0,10}$"></asp:RegularExpressionValidator></span></div>
