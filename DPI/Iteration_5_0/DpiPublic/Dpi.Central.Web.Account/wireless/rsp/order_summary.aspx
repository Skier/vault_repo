...
<%@ Page language="c#" Codebehind="order_summary.aspx.cs" AutoEventWireup="false" Inherits="Dpi.Central.Web.Account.Wireless.Processes.Rsp.OrderSummaryPage" %>
			...
			<div class="process_form">
				...
				<TABLE class="process_table">
					...
					<TR>
						...
						<TD align="right"><asp:imagebutton id="btnPayCreditCard" runat="server" ImageUrl="../../images/btn_pay_by_credit_card.gif"></asp:imagebutton><img src="../../images/blank.gif">
							<asp:imagebutton id="btnPayCheck" runat="server" ImageUrl="../../images/btn_pay_by_check.gif"></asp:imagebutton></TD>
					</TR>
				</TABLE>
			</div>
		</form>
