<%@ Control Language="c#" AutoEventWireup="false" Codebehind="receipt.ascx.cs" Inherits="Dpi.Central.Web.Account.Wireless.Processes.Rsp.AccountSummaryControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
