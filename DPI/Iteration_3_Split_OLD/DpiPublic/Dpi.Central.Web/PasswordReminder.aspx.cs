    ...
    public class PasswordReminder : BaseAccountPage
    {
        ...
        private RemindPasswordResult RemindPassword(int accountNumber)
        {
            ...
            if (res1.Status == WebValidationResultStatus.ValidCustomer) {
                ...
                EmailSender.SendPasswordRemider(res1.EmailAddress, CustInfo.CapitalizeName(result.AccountInfo.FirstName) + " " + CustInfo.CapitalizeName(result.AccountInfo.LastName), res1.WebPassword);
            } else {
