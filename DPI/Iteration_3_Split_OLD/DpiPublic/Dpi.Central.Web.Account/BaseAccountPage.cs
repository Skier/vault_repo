...
namespace Dpi.Central.Web.Account
{
    ...
    public class BaseAccountPage : Page
    {
		...
		//protected DpiSession _dpiSession;
...
//			if (MustHaveSession())
//			{
//				_dpiSession  = (DpiSession)Session[DpiSession.DPI_SESSION_KEY];
//				if (_dpiSession == null)
//				{
//					HttpContext.Current.Response.Redirect(SiteMap.LOGIN_URL);					
//				}
//			}
	       }
...
//			_dpiSession = new DpiSession();
//			_dpiSession.IsAuthenticated = true;
//			Session[DpiSession.DPI_SESSION_KEY] = _dpiSession;

        }

		protected virtual bool MustHaveSession()
		{
			return true;
		}
