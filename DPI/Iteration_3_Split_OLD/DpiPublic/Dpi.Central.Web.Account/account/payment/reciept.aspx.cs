    ...
    public class RecieptPage : BasePaymentPage
    {
        ...
        private void Page_Load(object sender, EventArgs e) 
        {
            if (!IsPostBack) 
			{
				...
				lblAccountNumber.Text = CustInfo.CapitalizeName(payment.Demand.Consumer.AccNumber.ToString());
				lblPhoneNumber.Text = CustInfo.CapitalizeName(payment.Demand.Consumer.PhNumber);
				
				lblFirstName.Text = CustInfo.CapitalizeName(Acct.FirstName);
				lblLastName.Text = CustInfo.CapitalizeName(Acct.LastName);				
