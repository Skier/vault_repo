...
namespace Dpi.Central.Web
{
    public class SignupPage : BaseAccountPage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            lnkLogin.NavigateUrl = SiteMap.LOGIN_URL;
        }
		...
		protected override bool MustHaveSession()
		{
			return false;
		}
        ...
        private void SubmitHandler(object sender, ImageClickEventArgs e)
        {
            ...
            if (password == null || password.Length == 0) {
                ...
                ShowError(
                    string.Format(
                        "Password must have at least {0} characters", 6));
                return;
            } else if (password.Length > 25) {
                ShowError(
                    string.Format(
                        "Password cannot be longer then {0} characters", 25));
                return;
            }
                ...
                case WebValidationResultStatus.CustomerNotSetupYet:
                    ...
                    switch (res2) {
                        case EnableWebAccessStatus.Success:
                            ...
                            EmailSender.SendNewAccountNotification(email, CustInfo.CapitalizeName(acctInfo.FirstName) + " " + CustInfo.CapitalizeName(acctInfo.LastName));
                            CreateFormAuthenticationTicket(accNumber.ToString());
                            HttpContext.Current.Response.Redirect(SiteMap.ACCOUNT_SUMMARY_URL, true);
