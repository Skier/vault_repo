    ...
    public class HeaderUserControl : UserControl
    {
        ...
        class Menu
        {
            ...
            public string GetLoadingClientScript()
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append(string.Format("\twindow.{0} = new Menu(\"root\",192,16," 
        ...
        const string MENU_KEY = "MENU_KEY";
        const string MENU_LIB_KEY = "MENU_LIB_KEY";
        const string MENU_LIB_SRC = "<SCRIPT language=\"JavaScript\" type=\"text/javascript\" src=\"{0}/script/mm_menu.js\"></script>";

        #endregion

        #region Web Form Designer generated code

        protected System.Web.UI.HtmlControls.HtmlTable _contentTable;
        protected System.Web.UI.HtmlControls.HtmlTableCell _buttonColumn;
        ...
        protected override void OnLoad(EventArgs e) {
            ...
            _buttonColumn.Attributes.Add("background", 
        ...
        private void InitializeComponent() {
            btnImgLogout.Click += new ImageClickEventHandler(this.btnImgLogout_Click);
        }
        ...
        private MenuBar BuildMenuBar() 
        {
            ...
            Menu menu = new Menu("home", Request.ApplicationPath + "/index.aspx", 
                Request.ApplicationPath + "/images/home_button.gif", 
                Request.ApplicationPath + "/images/home_button_on.gif");
            menuBar.Menus.Add(menu);
            
            menu = new Menu("products", Request.ApplicationPath + "/products.aspx", 
            ...
            menu.Items.Add(new MenuItem("Pre-Paid&nbsp;Home&nbsp;Phone&nbsp;Service", Request.ApplicationPath + "/pphp.aspx"));
            ...
            menu = new Menu("become_an_agent", Request.ApplicationPath + "/reseller.aspx", 
            ...
            menu = new Menu("agent", "https://secure.dpiteleconnect.com/agents/", 
                Request.ApplicationPath + "/images/ainfo_button.gif", 
                Request.ApplicationPath + "/images/ainfo_button_on.gif");
            menu.Target = "_blank";
            menuBar.Menus.Add(menu);

            menu = new Menu("account", Request.ApplicationPath + "/account/summary.aspx", 
            ...
            menu = new Menu("about_us", Request.ApplicationPath + "/about.aspx", 
            ...
            menu = new Menu("contact_us", Request.ApplicationPath + "/contact.aspx", 
            ...
            menu.Items.Add(new MenuItem("Find&nbsp;A&nbsp;Reseller&nbsp;Near&nbsp;You", Request.ApplicationPath + "/locations.aspx"));
            menuBar.Menus.Add(menu);
        ...
        private HtmlTable BuildMenuBarTable(MenuBar bar)
        {
            ...
            foreach (Menu menu in bar.Menus) {
                ...
                anch.Attributes.Add("onmouseover", (menu.Items.Count > 0 ? "MM_showMenu(window." + menu.Id + ",0,30,null,'" + menu.Id + "_Image" + "');" : string.Empty)
                    + "MM_swapImage('" + menu.Id + "_Image" + "','','" + menu.ImageOnUrl + "',1);");
                anch.Attributes.Add("onmouseout", (menu.Items.Count > 0 ? "MM_startTimeout();" : string.Empty) 
                    + "MM_swapImgRestore();");
