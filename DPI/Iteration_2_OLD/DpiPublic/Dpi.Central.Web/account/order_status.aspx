      ...
      <TABLE class=layout_table>
        <TR>
          <TD>
            <h2>Orders</H2></TD></TR>
        <TR>
          <TD align=center><ASP:DATAGRID id=grdOrderStatuses runat="server" CellPadding="3" ENABLEVIEWSTATE="False" pagesize="20" autogeneratecolumns="False" allowsorting="True">
