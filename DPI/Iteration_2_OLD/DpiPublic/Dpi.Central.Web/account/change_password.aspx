...
<%@ Page language="c#" Codebehind="change_password.aspx.cs" AutoEventWireup="false" Inherits="Dpi.Central.Web.account.change_password" %>
						...
						<TABLE class="layout_table">
							...
							<TR>
								...
								<TD class="property_validator">
									<asp:RequiredFieldValidator id="vldRfPassword" runat="server" ErrorMessage="Password can not be empty" Display="None"
										DESIGNTIMEDRAGDROP="111" ControlToValidate="txtNewPwd"></asp:RequiredFieldValidator></TD>
							</TR>
							<TR>
								<TD class="property_name">
								...
								<TD class="property_validator">
									<asp:CompareValidator id="vldCmpConfirmPassword" runat="server" ErrorMessage="Confirmation failed" Display="None"
										ControlToValidate="txtConfirmPwd" ControlToCompare="txtNewPwd"></asp:CompareValidator></TD>
							</TR>
							<TR>
								<TD noWrap></TD>
								<TD align="right">
