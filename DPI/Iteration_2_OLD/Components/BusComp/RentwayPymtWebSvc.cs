...
public class RentwayPymtWebSvc : System.Web.Services.Protocols.SoapHttpClientProtocol 
{
    
	/// <remarks/>
	public RentwayPymtWebSvc() 
	{
		string urlSetting = System.Configuration.ConfigurationSettings.AppSettings["RentwayWebserviceURL"];
		if ((urlSetting != null)) 
		{
			this.Url = urlSetting;
		}
