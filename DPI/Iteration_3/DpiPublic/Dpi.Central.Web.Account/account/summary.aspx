					...
					<td valign="top" align="left">
						...
						<table class="layout_table">
							...
							<tr>
								...
								<td colspan="2">
									<table border="0" cellspacing="0" cellpadding="0" class="linkTable">
										<tr>
											<td nowrap><asp:HyperLink ID="lnkAccSettings" runat="server" NavigateUrl="~/account/account_settings.aspx"
													onclick="this.blur()"><img src="../images/contact.gif" alt="">Account Settings</asp:HyperLink></td>
											...
											<td nowrap><asp:HyperLink ID="lnkPayment" runat="server" NavigateUrl="~/account/payment/payment_selection.aspx"
													onclick="this.blur()"><img src="../images/icon_cash.gif" alt="">Make a Payment</asp:HyperLink></td>
											<td nowrap><asp:HyperLink ID="lnkPromiseToPay" runat="server" NavigateUrl="~/account/payment/promise_to_pay.aspx"
													onclick="this.blur()"><img src="../images/promisetopay.gif" alt="">Promise To Pay</asp:HyperLink></td>
											<td nowrap><asp:HyperLink ID="lnkRecurringSetup" runat="server" NavigateUrl="~/account/payment/rec_payment_manager.aspx"
							...
							<tr>
								...
								<td class="05_con_bold"><font color="red"><ctl:ControlLabel id="lblLastDay" runat="server" Width="100%" SIMPLETEXT="True" Visible="False"></ctl:ControlLabel></font></td>
							</tr>
							<tr>
								<td class="left_padding"></td>
