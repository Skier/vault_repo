						...
						<table align="center" cellpadding="2" class="layout_table" style="WIDTH: 500px">
							...
							<tr>
								<td colspan="2">
									...
									<asp:ValidationSummary ID="vldSummary" runat="server" CssClass="Error" DisplayMode="List"></asp:ValidationSummary>
							...
							<tr runat="server" id="pastDueRow">
								<td><p>Balance Forward<br>
										<span style="FONT-WEIGHT: normal">The Balance Forward should be paid to avoid interruption of service</span></p>
								</td>
								<td align="right">
							...
							<tr>
								<td style="HEIGHT: 34px" colspan="2" align="right">
									<asp:Label id="lblAmt" runat="server">Payment Amount, $</asp:Label>&nbsp;
