...
namespace Dpi.Central.Web.Account
{
    public class SummaryPage : BaseAccountPage
    {
        ...
        private void InitAccountInfo()
        {
            ...
            string[] nameTokens = custInfo.CustInfo.FormattedName.Split(' ');
            StringBuilder sb = new StringBuilder();
            foreach (string nameToken in nameTokens) {
                sb.Append(CustInfo.CapitalizeName(nameToken));
                sb.Append(" ");
            }
            string formattedName = sb.ToString().Trim();
            lblCustomerName.Text = formattedName;
            ...
            lnkPayment.Enabled = acctInfo.PhNumFormated != null && acctInfo.PhNumFormated != string.Empty && !disconnected;
        }
