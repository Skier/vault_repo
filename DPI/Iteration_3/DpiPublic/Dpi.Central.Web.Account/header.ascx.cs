...
namespace Dpi.Central.Web.Account
{
    public class HeaderUserControl : UserControl
    {
        ...
        private MenuBar BuildMenuBar() {
            ...
            Menu menu = new Menu(
                "home",
                SiteMap.PublicSiteUrl + "/index.aspx",
            ...
            menu = new Menu(
                "products",
                SiteMap.PublicSiteUrl + "/products.aspx",
                Request.ApplicationPath + "/images/products_button.gif",
                Request.ApplicationPath + "/images/products_button_on.gif");
            menu.Items.Add(new MenuItem("Overview", SiteMap.PublicSiteUrl + "/products.aspx"));
            menu.Items.Add(
                new MenuItem("Pre-Paid&nbsp;Home&nbsp;Phone&nbsp;Service", SiteMap.PublicSiteUrl + "/pphp.aspx"));
            menu.Items.Add(new MenuItem("Pre-Paid&nbsp;Long&nbsp;Distance", SiteMap.PublicSiteUrl + "/ppld.aspx"));
            menu.Items.Add(new MenuItem("Pre-Paid&nbsp;Cellular", SiteMap.PublicSiteUrl + "/ppc.aspx"));
            menu.Items.Add(new MenuItem("Pre-Paid&nbsp;MasterCard", SiteMap.PublicSiteUrl + "/ppmc.aspx"));
            menu.Items.Add(new MenuItem("Pre-Paid&nbsp;Internet", SiteMap.PublicSiteUrl + "/ppi.aspx"));
            menu.Items.Add(new MenuItem("Bill&nbsp;Pay", SiteMap.PublicSiteUrl + "/bp.aspx"));
            menuBar.Menus.Add(menu);

            menu = new Menu(
                "become_an_agent",
                SiteMap.PublicSiteUrl + "/reseller.aspx",
                Request.ApplicationPath + "/images/reseller_button.gif",
                Request.ApplicationPath + "/images/reseller_button_on.gif");
            menu.Items.Add(new MenuItem("Overview", SiteMap.PublicSiteUrl + "/reseller.aspx"));
            menu.Items.Add(new MenuItem("Benefits", SiteMap.PublicSiteUrl + "/reseller2.aspx"));
            menu.Items.Add(new MenuItem("Sign&nbsp;Up&nbsp;Now", SiteMap.PublicSiteUrl + "/agent_contact.aspx"));
            menuBar.Menus.Add(menu);
            ...
            menu =
                new Menu(
                    "account",
                    SiteMap.AccountSiteUrl + ("/account/summary.aspx"),
                    Request.ApplicationPath + "/images/account_button.gif",
                    Request.ApplicationPath + "/images/account_button_on.gif");

            menu.Items.Add(new MenuItem("Sign&nbsp;Up&nbsp;Now", SiteMap.AccountSiteUrl + "/signup.aspx"));
            menu.Items.Add(new MenuItem("Account&nbsp;Login", SiteMap.AccountSiteUrl + "/account/login.aspx"));

            if (auth) {
                menu.Items.Add(new MenuItem("Account&nbsp;Summary", SiteMap.AccountSiteUrl + "/account/summary.aspx"));
            }
            ...
            menu = new Menu(
                "about_us",
                SiteMap.PublicSiteUrl + "/about.aspx",
                Request.ApplicationPath + "/images/about_button.gif",
                Request.ApplicationPath + "/images/about_button_on.gif");
            menu.Items.Add(new MenuItem("About&nbsp;Us", SiteMap.PublicSiteUrl + "/about.aspx"));
            menu.Items.Add(new MenuItem("Employment", SiteMap.PublicSiteUrl + "/jobs.aspx"));
            menuBar.Menus.Add(menu);

            menu = new Menu(
                "contact_us",
                SiteMap.PublicSiteUrl + "/contact.aspx",
                Request.ApplicationPath + "/images/contact_button.gif",
                Request.ApplicationPath + "/images/contact_button_on.gif");
            menu.Items.Add(new MenuItem("Contact&nbsp;dPi", SiteMap.PublicSiteUrl + "/contact.aspx"));
            menu.Items.Add(
                new MenuItem(
                    "Find&nbsp;A&nbsp;Reseller&nbsp;Near&nbsp;You", SiteMap.PublicSiteUrl + "/locations.aspx"));
            menuBar.Menus.Add(menu);
