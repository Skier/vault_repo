...
namespace Dpi.Central.Web.Account.Controls
{
    ...
    public class DatePicker : UserControl, IEnablable, IRequired
    {
        ...
        public DateTime CurrentDate
        {
            get
            {
                ...
                DateTime dt = new DateTime(
                    int.Parse(lstYear.SelectedValue),
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            lstMonth.Attributes.Add(
                "onChange", "UpdateDaysList(" + lstMonth.ClientID + ", " + lstDay.ClientID + ", " + lstYear.ClientID + ");");
            lstYear.Attributes.Add(
                "onChange", "UpdateDaysList(" + lstMonth.ClientID + ", " + lstDay.ClientID + ", " + lstYear.ClientID + ");");
            base.OnLoad(e);
        }
    }
